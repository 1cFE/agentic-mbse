...
- **Part 1:** `{SYSML_DOCS_PATH}/SysML_Spec_v2_Part1/full_document.md` (language constructs)
- **Part 2:** `{SYSML_DOCS_PATH}/SysML_Spec_v2_Part2/INDEX.md` + `full_document.md` (32,376 lines, v1→v2 mappings)
- **Part 3:** `{SYSML_DOCS_PATH}/SysML_Spec_v2_Part3/INDEX.md` + `full_document.md` (2,000 lines, API/Services)

### Guides and References
- **Intro Guide:** `{SYSML_DOCS_PATH}/SysML_IntroGuide_v2/full_document.md` (examples, tutorials)
- **Cheatsheet:** `{SYSML_DOCS_PATH}/Cheatsheet/` (quick syntax reference)
- **Concepts:** `{SYSML_DOCS_PATH}/SysML_HoltPerryConcepts_v20/` (conceptual overview)
...
Grep pattern="[Rr]equirement" in {SYSML_DOCS_PATH}/SysML_Spec_v2_Part2/INDEX.md
```
