...
grep -n -i "search_term" agent_literature/SysML/*/full_document.md

# Use context flags to preview (but don't rely on them for full content)
grep -n -B 2 -A 2 "pattern" agent_literature/SysML/SysML_Spec_v2_Part2/full_document.md
```
...
Read(
    file_path="agent_literature/SysML/SysML_Spec_v2_Part2/full_document.md",
...
```bash
grep -r "keyword" agent_literature/syside-docs/v0.8.1/api/
...
1. **Grep for keywords:**
   ```bash
   grep -n -i "requirement.*constraint" agent_literature/SysML/*/full_document.md
   grep -n -i "RequirementConstraintKind" agent_literature/SysML/*/full_document.md
   ```
...
3. **Read targeted sections:**
   ...
   Read("agent_literature/SysML/SysML_Spec_v2_Part2/full_document.md", offset=2250, limit=250)
   ```

4. **Search for examples:**
   ```bash
   grep -n -i "requirement.*example" agent_literature/SysML/SysML_IntroGuide_v2/full_document.md
   ```
