...
- **API Overview:** `{SYSIDE_DOCS_PATH}/api/README.md`
- **API Reference:** `{SYSIDE_DOCS_PATH}/api/generated/` (100+ class/function references)
- **Automator Guide:** `{SYSIDE_DOCS_PATH}/automator/advanced.md` (expression evaluation, execution)
- **Examples:** `{SYSIDE_DOCS_PATH}/examples/` (usage patterns)
...
Grep pattern="load_model" in {SYSIDE_DOCS_PATH}/api/

# Find expression evaluation
Grep pattern="[Ee]valuate" in {SYSIDE_DOCS_PATH}/automator/
```
...
Read {SYSIDE_DOCS_PATH}/api/generated/syside.Model.md

# Read automator advanced guide
Read {SYSIDE_DOCS_PATH}/automator/advanced.md
```
...
```
# Find example files
Glob {SYSIDE_DOCS_PATH}/examples/*.md

# Read specific example
Read {SYSIDE_DOCS_PATH}/examples/type_checking.md
```
...
- Check `{SYSIDE_DOCS_PATH}/automator/advanced.md`
