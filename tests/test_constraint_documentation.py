"""Durable constraint guidance must describe the executable-profile v4 contract."""
...
def test_constraint_guide_has_one_four_outcome_contract() -> None:
    ...
    assert "executable profile v4" in guide
    assert "Integer/Real operands or two Quantity operands" in guide
    assert "polarity" in guide
    assert "positive predicate" in guide
