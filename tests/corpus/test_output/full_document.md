...
## FIGURE 1. Fusion gain Q plotted against toroidal field on axis B 0 and major radius R 0. Gain
...
radius of approximately 6 m to achieve Q ≈ 10. In this sense, ITER FEAT was designed
...
![](images/sparc_overview.pdf-3-4.png)
...
as rapidly as possible to deuterium–tritium operation and Q > 2. While the exact duration
...
![](images/sparc_overview.pdf-7-3.png)
...
![](images/sparc_overview.pdf-10-4.png)
...
![](images/sparc_overview.pdf-11-2.png)

![](images/sparc_overview.pdf-11-3.png)

![](images/sparc_overview.pdf-11-9.png)

![](images/sparc_overview.pdf-11-10.png)

![](images/sparc_overview.pdf-11-11.png)

![](images/sparc_overview.pdf-11-12.png)
...
SPARC mission of Q > 2. This margin allows one to, for example, run scenarios with

highly dissipative divertor solutions even if they lead to degradation of core confinement,
and still achieve the mission of Q > 2. In addition, SPARC is projected to meet its Q > 2
...
remarkable agreement with the empirical prediction of Q ≈ 11. Such agreement reduces
...
## plasmas in hybrid scenario, experimental observations and modelling. Nucl. Fusion 54 (8), 083028.
...
## confinement regimes in the Alcator C-Mod tokamak. Nucl. Fusion 58 (9), 094002.
...
## width from present tokamaks to ITER. Nucl. Fusion 57 (11), 116023.
...
## Optimal regimes for ignition and the Ignitor experiment. Nucl. Fusion 41 (9), 1253–1257.

COSTLEY, A. E. 2016 On the fusion triple product and fusion power gain of tokamak pilot plants and
## reactors. Nucl. Fusion 56 (6), 066003.
...
## near the scrape-off layer H-mode power width and implications for ITER. Nucl. Fusion 53 (9),
...
## test reactor. Nucl. Technol. Fusion 4 (2P2), 326–335.
...
## Plasma Phys. Control. Fusion 59 (5), 055015.
...
## scalings. Nucl. Fusion 47 (9), L26–L29.
...
## confinement in Alcator C-Mod. Nucl. Fusion 37 (6), 793–807.
...
## NEILSON, G. H. 1988 A new look at density limits in tokamaks. Nucl. Fusion 28 (12),
...
## plasma performance. Nucl. Fusion 22 (7), 935–945.
...
## overview and summary. Nucl. Fusion 39 (12), 2137–2174.
...
## Chapter 2: plasma confinement and transport. Nucl. Fusion 39 (12), 2175–2249.
...
## of impurity radiation and its effects on tokamak experiments. Nucl. Fusion 17 (6), 1187–1196.
...
## tokamak. Nucl. Fusion 41 (10), 1515–1523.

LIN, Y., WRIGHT, J. C. & WUKITCH, S. J. 2020 ICRF on the SPARC tokamak. _J. Plasma Phys_ .
(under review).
## LUXON, J. L. 2002 A design retrospective of the DIII-D tokamak. Nucl. Fusion 42 (5), 614–633.
...
## contributions for DEMO plasma development. Nucl. Fusion 47 (6), S404–S413.
...
## and main chamber plasma facing components in future fusion devices. Nucl. Fusion 45 (3),
...
## S. M. 1985 Progress in tokamak research at MIT. Nucl. Fusion 25 (9), 1127–1136. REINKE, M. L. 2017 Heat flux mitigation by impurity seeding in high-field tokamaks. Nucl. Fusion 57 (3),
...
## 86. doi:10.1017/S0022377820001087.
...
## summary. Nucl. Fusion 47 (6), S1–S17.
...
## Control. Fusion 39 (12B), B103–B114.
...
## profiles in JT-60U tokamak and LHD helical plasmas with low collisionality. Nucl. Fusion 48 (7),
...
## strength and consequences for next-generation tokamaks. Nucl. Fusion 59 (4), 046020.
...
## Nucl. Fusion 59 (12), 126039.

YUSHMANOV, P. N., TAKIZUKA, T., RIEDEL, K. S., KARDAUN, O. J. W. F., CORDEY, J. G., KAYE,
## S. M. & POST, D. E. 1990 Scalings for tokamak energy confinement. Nucl. Fusion 30 (10),
...
## the tokamak fusion test reactor DT experiment. Plasma Phys. Control. Fusion 39 (5A), A275–A283.
