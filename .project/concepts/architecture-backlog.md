...
|----|-------|----------|----------------|--------|
| B-001 | [Model Implementation as a first-class concern](#b-001-model-implementation-as-a-first-class-concern) | High | Phase 1A | Open |
| B-002 | [Knowledge evolution and traceability are incomplete](#b-002-knowledge-evolution-and-traceability-are-incomplete) | High | Phase 1A | Open |
| B-003 | [Delete intent dimension; simplify work item taxonomy](#b-003-delete-intent-dimension-simplify-work-item-taxonomy) | Medium | Phase 1A | Open |
| B-004 | [Downstream pipeline is invisible](#b-004-downstream-pipeline-is-invisible) | Medium-High | Phase 1A | Open |
| B-005 | [Markdown parsing as state store is fragile](#b-005-markdown-parsing-as-state-store-is-fragile) | Medium | Phase 1A | Open |
| B-006 | [No decision promotion path from design.md to ARCHITECTURE.md](#b-006-no-decision-promotion-path) | Low | Phase 3D | Open |
| B-007 | [/review-model vs /audit-models boundary underspecified](#b-007-review-model-vs-audit-models-boundary) | Low | Phase 3D | Open |
| B-008 | [No inline knowledge capture during non-research commands](#b-008-no-inline-knowledge-capture) | Low-Medium | Phase 3D | Open |
| B-009 | [SOURCE_INDEX.md placement inconsistent](#b-009-source_indexmd-placement-inconsistent) | Low | Phase 1A | Subsumed by B-012 |
| B-010 | [No migration strategy for existing projects](#b-010-no-migration-strategy-for-existing-projects) | Medium-High | Phase 3E | Open |
| B-011 | [AP-7 Tier 2 claude -p dependency unaddressed](#b-011-ap-7-tier-2-claude--p-dependency) | Medium | Phase 3E | Open |
| B-012 | [File structure should reflect information flow model](#b-012-file-structure-should-reflect-information-flow-model) | High | Phase 1A | Open |
