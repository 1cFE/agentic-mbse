<div id="featurechainexpression" class="section">

<span id="metamodel-kerml-featurechainexpression"></span>

# FeatureChainExpression[](#featurechainexpression "Link to this heading")

`FeatureChainExpression` is defined in KerML specification on [page 233](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=233). Excerpt from the machine readable specification:
...
Attributes defined in [`FeatureChainExpression`](#syside.FeatureChainExpression "syside.FeatureChainExpression"):

[`target_feature`](#syside.FeatureChainExpression.target_feature "syside.FeatureChainExpression.target_feature")
...
The following table lists Syside specific attributes available for class [`FeatureChainExpression`](#syside.FeatureChainExpression "syside.FeatureChainExpression"):
...
| ------------------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                                      |
| [`STD`](#syside.FeatureChainExpression.STD "syside.FeatureChainExpression.STD")                                                       |
| [`target_feature_member`](#syside.FeatureChainExpression.target_feature_member "syside.FeatureChainExpression.target_feature_member") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">FeatureChainExpression</span></span>[](#syside.FeatureChainExpression "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::FeatureChainExpression'</span>*[](#syside.FeatureChainExpression.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.FeatureChainExpression</span>](#syside.FeatureChainExpression "syside.FeatureChainExpression")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.FeatureChainExpression.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.FeatureChainExpression.target_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target\_feature\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.TargetFeatureAccessor</span>](/v0.8.1/api/generated/syside.TargetFeatureAccessor.md "syside.TargetFeatureAccessor")*[](#syside.FeatureChainExpression.target_feature_member "Link to this definition")
