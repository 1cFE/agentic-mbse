<div id="collectexpression" class="section">

<span id="metamodel-kerml-collectexpression"></span>

# CollectExpression[](#collectexpression "Link to this heading")

`CollectExpression` is defined in KerML specification on [page 231](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=231). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `CollectExpression` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: CollectExpression digraph { CollectExpression \[label="CollectExpression (KerML)" shape=plaintext\] OperatorExpression -\> CollectExpression OperatorExpression \[label="OperatorExpression (KerML)" shape=plaintext\] InvocationExpression -\> OperatorExpression InvocationExpression \[label="InvocationExpression (KerML)" shape=plaintext\] InstantiationExpression -\> InvocationExpression InstantiationExpression \[label="InstantiationExpression (KerML)" shape=plaintext\] Expression -\> InstantiationExpression Expression \[label="Expression (KerML)" shape=plaintext\] Step -\> Expression Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-a3974c16d5871af9c04e46716d2ff7b5caaabd60.png)

</div>

</div>

The following table shows all attributes defined for `CollectExpression` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`CollectExpression`](#syside.CollectExpression "syside.CollectExpression"):
...
The following table lists Syside specific attributes available for class [`CollectExpression`](#syside.CollectExpression "syside.CollectExpression"):
...
| --------------------------------------------------------------------- |
| Python Attribute                                                      |
| [`STD`](#syside.CollectExpression.STD "syside.CollectExpression.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">CollectExpression</span></span>[](#syside.CollectExpression "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::CollectExpression'</span>*[](#syside.CollectExpression.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.CollectExpression</span>](#syside.CollectExpression "syside.CollectExpression")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.CollectExpression.STD "Link to this definition")
