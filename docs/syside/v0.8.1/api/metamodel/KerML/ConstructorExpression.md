<div id="constructorexpression" class="section">

<span id="metamodel-kerml-constructorexpression"></span>

# ConstructorExpression[](#constructorexpression "Link to this heading")

`ConstructorExpression` is defined in KerML specification on [page 232](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=232). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ConstructorExpression` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ConstructorExpression digraph { ConstructorExpression \[label="ConstructorExpression (KerML)" shape=plaintext\] InstantiationExpression -\> ConstructorExpression InstantiationExpression \[label="InstantiationExpression (KerML)" shape=plaintext\] Expression -\> InstantiationExpression Expression \[label="Expression (KerML)" shape=plaintext\] Step -\> Expression Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-660d3e63e2db7a5b43b93d82c4a5da8512fa6bb3.png)

</div>

</div>

The following table shows all attributes defined for `ConstructorExpression` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ConstructorExpression`](#syside.ConstructorExpression "syside.ConstructorExpression"):
...
The following table lists Syside specific attributes available for class [`ConstructorExpression`](#syside.ConstructorExpression "syside.ConstructorExpression"):
...
| ----------------------------------------------------------------------------- |
| Python Attribute                                                              |
| [`STD`](#syside.ConstructorExpression.STD "syside.ConstructorExpression.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ConstructorExpression</span></span>[](#syside.ConstructorExpression "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ConstructorExpression'</span>*[](#syside.ConstructorExpression.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConstructorExpression</span>](#syside.ConstructorExpression "syside.ConstructorExpression")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ConstructorExpression.STD "Link to this definition")
