<div id="differencing" class="section">

<span id="metamodel-kerml-differencing"></span>

# Differencing[](#differencing "Link to this heading")

`Differencing` is defined in KerML specification on [page 56](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=56). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `Differencing` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: Differencing digraph { Differencing \[label="Differencing (KerML)" shape=plaintext\] Relationship -\> Differencing Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-2cc82a8ad088d64c67c72b5c05281941fcec7930.png)

</div>

</div>

The following table shows all attributes defined for `Differencing` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`Differencing`](#syside.Differencing "syside.Differencing"):

[`differencing_type`](#syside.Differencing.differencing_type "syside.Differencing.differencing_type")

`Type` that partly determines interpretations of `typeDifferenced`, as described in `Type::differencingType`.

[`type_differenced`](#syside.Differencing.type_differenced "syside.Differencing.type_differenced")
...
The following table lists Syside specific attributes available for class [`Differencing`](#syside.Differencing "syside.Differencing"):
...
| ----------------------------------------------------------------------------- |
| Python Attribute                                                              |
| [`CHAINABLE`](#syside.Differencing.CHAINABLE "syside.Differencing.CHAINABLE") |
| [`STD`](#syside.Differencing.STD "syside.Differencing.STD")                   |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">Differencing</span></span>[](#syside.Differencing "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::Differencing'</span>*[](#syside.Differencing.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Differencing</span>](#syside.Differencing "syside.Differencing")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.Differencing.STD "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">CHAINABLE</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">True</span>*[](#syside.Differencing.CHAINABLE "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">differencing\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.Differencing.differencing_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">type\_differenced</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.Differencing.type_differenced "Link to this definition")
