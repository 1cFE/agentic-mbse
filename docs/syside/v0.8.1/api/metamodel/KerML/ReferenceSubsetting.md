<div id="referencesubsetting" class="section">

<span id="metamodel-kerml-referencesubsetting"></span>

# ReferenceSubsetting[](#referencesubsetting "Link to this heading")

`ReferenceSubsetting` is defined in KerML specification on [page 205](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=205). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ReferenceSubsetting` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ReferenceSubsetting digraph { ReferenceSubsetting \[label="ReferenceSubsetting (KerML)" shape=plaintext\] Subsetting -\> ReferenceSubsetting Subsetting \[label="Subsetting (KerML)" shape=plaintext\] Specialization -\> Subsetting Specialization \[label="Specialization (KerML)" shape=plaintext\] Relationship -\> Specialization Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-734723b97ba43d688e61741c0bc4490ee34a956f.png)

</div>

</div>

The following table shows all attributes defined for `ReferenceSubsetting` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ReferenceSubsetting`](#syside.ReferenceSubsetting "syside.ReferenceSubsetting"):

[`referenced_feature`](#syside.ReferenceSubsetting.referenced_feature "syside.ReferenceSubsetting.referenced_feature")

The `Feature` that is referenced by the `referencingFeature` of this `ReferenceSubsetting`.

[`referencing_feature`](#syside.ReferenceSubsetting.referencing_feature "syside.ReferenceSubsetting.referencing_feature")
...
The following table lists Syside specific attributes available for class [`ReferenceSubsetting`](#syside.ReferenceSubsetting "syside.ReferenceSubsetting"):
...
| ---------------------------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                                               |
| [`CHAINABLE`](#syside.ReferenceSubsetting.CHAINABLE "syside.ReferenceSubsetting.CHAINABLE")                                                    |
| [`STD`](#syside.ReferenceSubsetting.STD "syside.ReferenceSubsetting.STD")                                                                      |
| [`referenced_feature_target`](#syside.ReferenceSubsetting.referenced_feature_target "syside.ReferenceSubsetting.referenced_feature_target")    |
| [`referencing_feature_target`](#syside.ReferenceSubsetting.referencing_feature_target "syside.ReferenceSubsetting.referencing_feature_target") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ReferenceSubsetting</span></span>[](#syside.ReferenceSubsetting "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ReferenceSubsetting'</span>*[](#syside.ReferenceSubsetting.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ReferenceSubsetting</span>](#syside.ReferenceSubsetting "syside.ReferenceSubsetting")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ReferenceSubsetting.STD "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">CHAINABLE</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">True</span>*[](#syside.ReferenceSubsetting.CHAINABLE "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referenced\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ReferenceSubsetting.referenced_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referencing\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ReferenceSubsetting.referencing_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referenced\_feature\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedFeatureReference</span>](/v0.8.1/api/generated/syside.ChainedFeatureReference.md "syside.ChainedFeatureReference")*[](#syside.ReferenceSubsetting.referenced_feature_target "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referencing\_feature\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedFeatureReference</span>](/v0.8.1/api/generated/syside.ChainedFeatureReference.md "syside.ChainedFeatureReference")*[](#syside.ReferenceSubsetting.referencing_feature_target "Link to this definition")
