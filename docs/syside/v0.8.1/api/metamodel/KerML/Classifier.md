...
<span id="metamodel-kerml-classifier"></span>

# Classifier[](#classifier "Link to this heading")

`Classifier` is defined in KerML specification on [page 57](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=57). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `Classifier` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: Classifier digraph { Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-830536882dd361798ddb200c6d921e12a7216cb5.png)

</div>

</div>

The following table shows all attributes defined for `Classifier` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`Classifier`](#syside.Classifier "syside.Classifier"):

[`owned_subclassifications`](#syside.Classifier.owned_subclassifications "syside.Classifier.owned_subclassifications")
...
The following table lists Syside specific attributes available for class [`Classifier`](#syside.Classifier "syside.Classifier"):
...
| ------------------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                                      |
| [`STD`](#syside.Classifier.STD "syside.Classifier.STD")                                                                               |
| [`owned_subclassification_types`](#syside.Classifier.owned_subclassification_types "syside.Classifier.owned_subclassification_types") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">Classifier</span></span>[](#syside.Classifier "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::Classifier'</span>*[](#syside.Classifier.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Classifier</span>](#syside.Classifier "syside.Classifier")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.Classifier.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_subclassifications</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Subclassification</span>](/v0.8.1/api/metamodel/KerML/Subclassification.md "syside.Subclassification")<span class="p"><span class="pre">\]</span></span>*[](#syside.Classifier.owned_subclassifications "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_subclassification\_types</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Classifier</span>](#syside.Classifier "syside.Classifier")<span class="p"><span class="pre">\]</span></span>*[](#syside.Classifier.owned_subclassification_types "Link to this definition")
