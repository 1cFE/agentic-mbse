<div id="redefinition" class="section">

<span id="metamodel-kerml-redefinition"></span>

# Redefinition[](#redefinition "Link to this heading")

`Redefinition` is defined in KerML specification on [page 62](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=62). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `Redefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: Redefinition digraph { Redefinition \[label="Redefinition (KerML)" shape=plaintext\] Subsetting -\> Redefinition Subsetting \[label="Subsetting (KerML)" shape=plaintext\] Specialization -\> Subsetting Specialization \[label="Specialization (KerML)" shape=plaintext\] Relationship -\> Specialization Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-fe5c446b7cda2b2ef379932d447bcc514e85070f.png)

</div>

</div>

The following table shows all attributes defined for `Redefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`Redefinition`](#syside.Redefinition "syside.Redefinition"):

[`redefined_feature`](#syside.Redefinition.redefined_feature "syside.Redefinition.redefined_feature")

The `Feature` that is redefined by the `redefiningFeature` of this `Redefinition`.

[`redefining_feature`](#syside.Redefinition.redefining_feature "syside.Redefinition.redefining_feature")
...
The following table lists Syside specific attributes available for class [`Redefinition`](#syside.Redefinition "syside.Redefinition"):
...
| ----------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                              |
| [`CHAINABLE`](#syside.Redefinition.CHAINABLE "syside.Redefinition.CHAINABLE")                                                 |
| [`STD`](#syside.Redefinition.STD "syside.Redefinition.STD")                                                                   |
| [`redefined_feature_target`](#syside.Redefinition.redefined_feature_target "syside.Redefinition.redefined_feature_target")    |
| [`redefining_feature_target`](#syside.Redefinition.redefining_feature_target "syside.Redefinition.redefining_feature_target") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">Redefinition</span></span>[](#syside.Redefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::Redefinition'</span>*[](#syside.Redefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Redefinition</span>](#syside.Redefinition "syside.Redefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.Redefinition.STD "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">CHAINABLE</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">True</span>*[](#syside.Redefinition.CHAINABLE "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">redefining\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.Redefinition.redefining_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">redefined\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.Redefinition.redefined_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">redefining\_feature\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedFeatureReference</span>](/v0.8.1/api/generated/syside.ChainedFeatureReference.md "syside.ChainedFeatureReference")*[](#syside.Redefinition.redefining_feature_target "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">redefined\_feature\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedFeatureReference</span>](/v0.8.1/api/generated/syside.ChainedFeatureReference.md "syside.ChainedFeatureReference")*[](#syside.Redefinition.redefined_feature_target "Link to this definition")
