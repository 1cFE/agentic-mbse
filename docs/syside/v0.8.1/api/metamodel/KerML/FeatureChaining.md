<div id="featurechaining" class="section">

<span id="metamodel-kerml-featurechaining"></span>

# FeatureChaining[](#featurechaining "Link to this heading")

`FeatureChaining` is defined in KerML specification on [page 202](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=202). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `FeatureChaining` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: FeatureChaining digraph { FeatureChaining \[label="FeatureChaining (KerML)" shape=plaintext\] Relationship -\> FeatureChaining Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-5bb1e49afcb718d7c9ffbd1ece0069e506db6b70.png)

</div>

</div>

The following table shows all attributes defined for `FeatureChaining` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`FeatureChaining`](#syside.FeatureChaining "syside.FeatureChaining"):

[`chaining_feature`](#syside.FeatureChaining.chaining_feature "syside.FeatureChaining.chaining_feature")

The `Feature` whose values partly determine values of `featureChained`, as described in `Feature::chainingFeature`.

[`feature_chained`](#syside.FeatureChaining.feature_chained "syside.FeatureChaining.feature_chained")
...
The following table lists Syside specific attributes available for class [`FeatureChaining`](#syside.FeatureChaining "syside.FeatureChaining"):
...
| ----------------------------------------------------------------------------------- |
| Python Attribute                                                                    |
| [`CHAINABLE`](#syside.FeatureChaining.CHAINABLE "syside.FeatureChaining.CHAINABLE") |
| [`STD`](#syside.FeatureChaining.STD "syside.FeatureChaining.STD")                   |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">FeatureChaining</span></span>[](#syside.FeatureChaining "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::FeatureChaining'</span>*[](#syside.FeatureChaining.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.FeatureChaining</span>](#syside.FeatureChaining "syside.FeatureChaining")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.FeatureChaining.STD "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">CHAINABLE</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">False</span>*[](#syside.FeatureChaining.CHAINABLE "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">chaining\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.FeatureChaining.chaining_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">feature\_chained</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.FeatureChaining.feature_chained "Link to this definition")
