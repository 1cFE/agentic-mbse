<div id="flowdefinition" class="section">

<span id="metamodel-sysml-flowdefinition"></span>

# FlowDefinition[](#flowdefinition "Link to this heading")

`FlowDefinition` is defined in SysML specification on [page 338](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=338). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `FlowDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: FlowDefinition digraph { FlowDefinition \[label="FlowDefinition (SysML)" shape=plaintext\] ActionDefinition -\> FlowDefinition Interaction -\> FlowDefinition ActionDefinition \[label="ActionDefinition (SysML)" shape=plaintext\] OccurrenceDefinition -\> ActionDefinition Behavior -\> ActionDefinition Interaction \[label="Interaction (KerML)" shape=plaintext\] Association -\> Interaction Behavior -\> Interaction OccurrenceDefinition \[label="OccurrenceDefinition (SysML)" shape=plaintext\] Definition -\> OccurrenceDefinition Class -\> OccurrenceDefinition Behavior \[label="Behavior (KerML)" shape=plaintext\] Class -\> Behavior Association \[label="Association (KerML)" shape=plaintext\] Classifier -\> Association Relationship -\> Association Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition Class \[label="Class (KerML)" shape=plaintext\] Classifier -\> Class Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Element \[label="Element (KerML)" shape=plaintext\] Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace }](_images/graphviz-630d3f03e6065014075924c0b0a7bbe55ea4c13d.png)

</div>

</div>

The following table shows all attributes defined for `FlowDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`FlowDefinition`](#syside.FlowDefinition "syside.FlowDefinition"):

[`flow_ends`](#syside.FlowDefinition.flow_ends "syside.FlowDefinition.flow_ends")
...
Attributes defined in [`Interaction`](/v0.8.1/api/metamodel/KerML/Interaction.md "syside.Interaction"):
...
Attributes defined in [`Association`](/v0.8.1/api/metamodel/KerML/Association.md "syside.Association"):

[`association_ends`](/v0.8.1/api/metamodel/KerML/Association.md "syside.Association.association_ends")
...
[`related_types`](/v0.8.1/api/metamodel/KerML/Association.md "syside.Association.related_types")
...
[`source_type`](/v0.8.1/api/metamodel/KerML/Association.md "syside.Association.source_type")

The source `relatedType` for this `Association`. It is the first `relatedType` of the `Association`.

[`target_types`](/v0.8.1/api/metamodel/KerML/Association.md "syside.Association.target_types")
...
The following table lists Syside specific attributes available for class [`FlowDefinition`](#syside.FlowDefinition "syside.FlowDefinition"):
...
| ------------------------------------------------------------------------ |
| Python Attribute                                                         |
| [`STD`](#syside.FlowDefinition.STD "syside.FlowDefinition.STD")          |
| [`source`](#syside.FlowDefinition.source "syside.FlowDefinition.source") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">FlowDefinition</span></span>[](#syside.FlowDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::FlowDefinition'</span>*[](#syside.FlowDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.FlowDefinition</span>](#syside.FlowDefinition "syside.FlowDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.FlowDefinition.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">flow\_ends</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.FeatureMembership</span>](/v0.8.1/api/metamodel/KerML/FeatureMembership.md "syside.FeatureMembership")<span class="p"><span class="pre">,</span></span><span class="w"> </span>[<span class="pre">syside.Usage</span>](/v0.8.1/api/metamodel/SysML/Usage.md "syside.Usage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.flow_ends "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">source</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.FlowDefinition.source "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">sources</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">list</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.sources "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning\_related\_element</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.FlowDefinition.owning_related_element "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">is\_implied</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span>*[](#syside.FlowDefinition.is_implied "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">related\_elements</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.related_elements "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">targets</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.targets "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_related\_elements</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.owned_related_elements "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">source\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.FlowDefinition.source_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">related\_types</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.related_types "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target\_types</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.target_types "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">association\_ends</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.association_ends "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">steps</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Step</span>](/v0.8.1/api/metamodel/KerML/Step.md "syside.Step")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.FlowUsage</span>](/v0.8.1/api/metamodel/SysML/FlowUsage.md "syside.FlowUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.steps "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">actions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.FlowUsage</span>](/v0.8.1/api/metamodel/SysML/FlowUsage.md "syside.FlowUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.FlowDefinition.actions "Link to this definition")
