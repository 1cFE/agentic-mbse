<div id="transitionfeaturemembership" class="section">

<span id="metamodel-sysml-transitionfeaturemembership"></span>

# TransitionFeatureMembership[](#transitionfeaturemembership "Link to this heading")

`TransitionFeatureMembership` is defined in SysML specification on [page 373](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=373). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `TransitionFeatureMembership` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: TransitionFeatureMembership digraph { TransitionFeatureMembership \[label="TransitionFeatureMembership (SysML)" shape=plaintext\] FeatureMembership -\> TransitionFeatureMembership FeatureMembership \[label="FeatureMembership (KerML)" shape=plaintext\] OwningMembership -\> FeatureMembership OwningMembership \[label="OwningMembership (KerML)" shape=plaintext\] Membership -\> OwningMembership Membership \[label="Membership (KerML)" shape=plaintext\] Relationship -\> Membership Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-5a172a00215614fb84ad9c1e515f628a2c278aae.png)

</div>

</div>

The following table shows all attributes defined for `TransitionFeatureMembership` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`TransitionFeatureMembership`](#syside.TransitionFeatureMembership "syside.TransitionFeatureMembership"):

[`kind`](#syside.TransitionFeatureMembership.kind "syside.TransitionFeatureMembership.kind")

Whether this `TransitionFeatureMembership` is for a `trigger`, `guard` or `effect`.

[`transition_feature`](#syside.TransitionFeatureMembership.transition_feature "syside.TransitionFeatureMembership.transition_feature")
...
The following table lists Syside specific attributes available for class [`TransitionFeatureMembership`](#syside.TransitionFeatureMembership "syside.TransitionFeatureMembership"):
...
| ----------------------------------------------------------------------------------------- |
| Python Attribute                                                                          |
| [`STD`](#syside.TransitionFeatureMembership.STD "syside.TransitionFeatureMembership.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">TransitionFeatureMembership</span></span>[](#syside.TransitionFeatureMembership "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::TransitionFeatureMembership'</span>*[](#syside.TransitionFeatureMembership.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.TransitionFeatureMembership</span>](#syside.TransitionFeatureMembership "syside.TransitionFeatureMembership")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.TransitionFeatureMembership.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">kind</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.TransitionFeatureKind</span>](/v0.8.1/api/metamodel/SysML/TransitionFeatureKind.md "syside.TransitionFeatureKind")*[](#syside.TransitionFeatureMembership.kind "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">transition\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.Expression</span>](/v0.8.1/api/metamodel/KerML/Expression.md "syside.Expression")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionFeatureMembership.transition_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionFeatureMembership.owning_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_member\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionFeatureMembership.owned_member_feature "Link to this definition")
