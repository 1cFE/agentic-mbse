<div id="assignmentactionusage" class="section">

<span id="metamodel-sysml-assignmentactionusage"></span>

# AssignmentActionUsage[](#assignmentactionusage "Link to this heading")

`AssignmentActionUsage` is defined in SysML specification on [page 348](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=348). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `AssignmentActionUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: AssignmentActionUsage digraph { AssignmentActionUsage \[label="AssignmentActionUsage (SysML)" shape=plaintext\] ActionUsage -\> AssignmentActionUsage ActionUsage \[label="ActionUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ActionUsage Step -\> ActionUsage OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-71aa4ae2013f581894dbeaf6d01fc2a113428b0e.png)

</div>

</div>

The following table shows all attributes defined for `AssignmentActionUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`AssignmentActionUsage`](#syside.AssignmentActionUsage "syside.AssignmentActionUsage"):

[`referent`](#syside.AssignmentActionUsage.referent "syside.AssignmentActionUsage.referent")

The `Feature` whose value is to be set.

[`target_argument`](#syside.AssignmentActionUsage.target_argument "syside.AssignmentActionUsage.target_argument")
...
[`value_expression`](#syside.AssignmentActionUsage.value_expression "syside.AssignmentActionUsage.value_expression")
...
The following table lists Syside specific attributes available for class [`AssignmentActionUsage`](#syside.AssignmentActionUsage "syside.AssignmentActionUsage"):
...
| -------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                     |
| [`STD`](#syside.AssignmentActionUsage.STD "syside.AssignmentActionUsage.STD")                                        |
| [`referent_member`](#syside.AssignmentActionUsage.referent_member "syside.AssignmentActionUsage.referent_member")    |
| [`target_member`](#syside.AssignmentActionUsage.target_member "syside.AssignmentActionUsage.target_member")          |
| [`target_parameter`](#syside.AssignmentActionUsage.target_parameter "syside.AssignmentActionUsage.target_parameter") |
| [`value_member`](#syside.AssignmentActionUsage.value_member "syside.AssignmentActionUsage.value_member")             |
| [`value_parameter`](#syside.AssignmentActionUsage.value_parameter "syside.AssignmentActionUsage.value_parameter")    |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AssignmentActionUsage</span></span>[](#syside.AssignmentActionUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AssignmentActionUsage'</span>*[](#syside.AssignmentActionUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AssignmentActionUsage</span>](#syside.AssignmentActionUsage "syside.AssignmentActionUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AssignmentActionUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target\_argument</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Expression</span>](/v0.8.1/api/metamodel/KerML/Expression.md "syside.Expression")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.AssignmentActionUsage.target_argument "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target\_parameter</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceUsage</span>](/v0.8.1/api/metamodel/SysML/ReferenceUsage.md "syside.ReferenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.AssignmentActionUsage.target_parameter "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ParameterAccessor</span>](/v0.8.1/api/generated/syside.ParameterAccessor.md "syside.ParameterAccessor")*[](#syside.AssignmentActionUsage.target_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">value\_expression</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Expression</span>](/v0.8.1/api/metamodel/KerML/Expression.md "syside.Expression")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.AssignmentActionUsage.value_expression "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">value\_parameter</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceUsage</span>](/v0.8.1/api/metamodel/SysML/ReferenceUsage.md "syside.ReferenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.AssignmentActionUsage.value_parameter "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">value\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ParameterAccessor</span>](/v0.8.1/api/generated/syside.ParameterAccessor.md "syside.ParameterAccessor")*[](#syside.AssignmentActionUsage.value_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referent</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.AssignmentActionUsage.referent "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referent\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedFeatureMemberAccessor</span>](/v0.8.1/api/generated/syside.ChainedFeatureMemberAccessor.md "syside.ChainedFeatureMemberAccessor")*[](#syside.AssignmentActionUsage.referent_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">behaviors</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Behavior</span>](/v0.8.1/api/metamodel/KerML/Behavior.md "syside.Behavior")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ActionDefinition</span>](/v0.8.1/api/metamodel/SysML/ActionDefinition.md "syside.ActionDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.AssignmentActionUsage.behaviors "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.AssignmentActionUsage.owned_parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.AssignmentActionUsage.parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">action\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Behavior</span>](/v0.8.1/api/metamodel/KerML/Behavior.md "syside.Behavior")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ActionDefinition</span>](/v0.8.1/api/metamodel/SysML/ActionDefinition.md "syside.ActionDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.AssignmentActionUsage.action_definitions "Link to this definition")
