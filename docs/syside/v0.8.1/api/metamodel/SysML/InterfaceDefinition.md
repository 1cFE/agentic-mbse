<div id="interfacedefinition" class="section">

<span id="metamodel-sysml-interfacedefinition"></span>

# InterfaceDefinition[](#interfacedefinition "Link to this heading")

`InterfaceDefinition` is defined in SysML specification on [page 334](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=334). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `InterfaceDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: InterfaceDefinition digraph { InterfaceDefinition \[label="InterfaceDefinition (SysML)" shape=plaintext\] ConnectionDefinition -\> InterfaceDefinition ConnectionDefinition \[label="ConnectionDefinition (SysML)" shape=plaintext\] PartDefinition -\> ConnectionDefinition AssociationStructure -\> ConnectionDefinition PartDefinition \[label="PartDefinition (SysML)" shape=plaintext\] ItemDefinition -\> PartDefinition AssociationStructure \[label="AssociationStructure (KerML)" shape=plaintext\] Association -\> AssociationStructure Structure -\> AssociationStructure ItemDefinition \[label="ItemDefinition (SysML)" shape=plaintext\] OccurrenceDefinition -\> ItemDefinition Structure -\> ItemDefinition Association \[label="Association (KerML)" shape=plaintext\] Classifier -\> Association Relationship -\> Association Structure \[label="Structure (KerML)" shape=plaintext\] Class -\> Structure OccurrenceDefinition \[label="OccurrenceDefinition (SysML)" shape=plaintext\] Definition -\> OccurrenceDefinition Class -\> OccurrenceDefinition Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Class \[label="Class (KerML)" shape=plaintext\] Classifier -\> Class Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Element \[label="Element (KerML)" shape=plaintext\] Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace }](_images/graphviz-02f2e75d43a04e3bf74f60f98cdf982e9085b1f9.png)

</div>

</div>

The following table shows all attributes defined for `InterfaceDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`InterfaceDefinition`](#syside.InterfaceDefinition "syside.InterfaceDefinition"):

[`interface_ends`](#syside.InterfaceDefinition.interface_ends "syside.InterfaceDefinition.interface_ends")

The `PortUsages` that are the `connectionEnds` of this `InterfaceDefinition`.

Attributes defined in [`ConnectionDefinition`](/v0.8.1/api/metamodel/SysML/ConnectionDefinition.md "syside.ConnectionDefinition"):

[`connection_ends`](/v0.8.1/api/metamodel/SysML/ConnectionDefinition.md "syside.ConnectionDefinition.connection_ends")

The `Usages` that define the things related by the `ConnectionDefinition`.

Attributes defined in [`PartDefinition`](/v0.8.1/api/metamodel/SysML/PartDefinition.md "syside.PartDefinition"):

Attributes defined in [`AssociationStructure`](/v0.8.1/api/metamodel/KerML/AssociationStructure.md "syside.AssociationStructure"):

Attributes defined in [`ItemDefinition`](/v0.8.1/api/metamodel/SysML/ItemDefinition.md "syside.ItemDefinition"):
...
The following table lists Syside specific attributes available for class [`InterfaceDefinition`](#syside.InterfaceDefinition "syside.InterfaceDefinition"):
...
| ------------------------------------------------------------------------- |
| Python Attribute                                                          |
| [`STD`](#syside.InterfaceDefinition.STD "syside.InterfaceDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">InterfaceDefinition</span></span>[](#syside.InterfaceDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::InterfaceDefinition'</span>*[](#syside.InterfaceDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.InterfaceDefinition</span>](#syside.InterfaceDefinition "syside.InterfaceDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.InterfaceDefinition.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">interface\_ends</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.PortUsage</span>](/v0.8.1/api/metamodel/SysML/PortUsage.md "syside.PortUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.interface_ends "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">connection\_ends</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Usage</span>](/v0.8.1/api/metamodel/SysML/Usage.md "syside.Usage")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.connection_ends "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">source</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.InterfaceDefinition.source "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">sources</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">list</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.sources "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning\_related\_element</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.InterfaceDefinition.owning_related_element "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">is\_implied</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span>*[](#syside.InterfaceDefinition.is_implied "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">related\_elements</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.related_elements "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">targets</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.targets "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_related\_elements</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.owned_related_elements "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">source\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.InterfaceDefinition.source_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">related\_types</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.related_types "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target\_types</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.target_types "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">association\_ends</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.InterfaceDefinition.association_ends "Link to this definition")
