<div id="analysiscaseusage" class="section">

<span id="metamodel-sysml-analysiscaseusage"></span>

# AnalysisCaseUsage[](#analysiscaseusage "Link to this heading")

`AnalysisCaseUsage` is defined in SysML specification on [page 406](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=406). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `AnalysisCaseUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: AnalysisCaseUsage digraph { AnalysisCaseUsage \[label="AnalysisCaseUsage (SysML)" shape=plaintext\] CaseUsage -\> AnalysisCaseUsage CaseUsage \[label="CaseUsage (SysML)" shape=plaintext\] CalculationUsage -\> CaseUsage CalculationUsage \[label="CalculationUsage (SysML)" shape=plaintext\] ActionUsage -\> CalculationUsage Expression -\> CalculationUsage ActionUsage \[label="ActionUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ActionUsage Step -\> ActionUsage Expression \[label="Expression (KerML)" shape=plaintext\] Step -\> Expression OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-2adbd765e4304def2d624aac1e5b1d60d7b6b727.png)

</div>

</div>

The following table shows all attributes defined for `AnalysisCaseUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`AnalysisCaseUsage`](#syside.AnalysisCaseUsage "syside.AnalysisCaseUsage"):

[`analysis_case_definition`](#syside.AnalysisCaseUsage.analysis_case_definition "syside.AnalysisCaseUsage.analysis_case_definition")
...
The following table lists Syside specific attributes available for class [`AnalysisCaseUsage`](#syside.AnalysisCaseUsage "syside.AnalysisCaseUsage"):
...
| --------------------------------------------------------------------- |
| Python Attribute                                                      |
| [`STD`](#syside.AnalysisCaseUsage.STD "syside.AnalysisCaseUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AnalysisCaseUsage</span></span>[](#syside.AnalysisCaseUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AnalysisCaseUsage'</span>*[](#syside.AnalysisCaseUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AnalysisCaseUsage</span>](#syside.AnalysisCaseUsage "syside.AnalysisCaseUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AnalysisCaseUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">analysis\_case\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.AnalysisCaseDefinition</span>](/v0.8.1/api/metamodel/SysML/AnalysisCaseDefinition.md "syside.AnalysisCaseDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.AnalysisCaseUsage.analysis_case_definition "Link to this definition")
