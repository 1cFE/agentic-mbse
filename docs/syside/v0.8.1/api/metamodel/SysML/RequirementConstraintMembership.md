<div id="requirementconstraintmembership" class="section">

<span id="metamodel-sysml-requirementconstraintmembership"></span>

# RequirementConstraintMembership[](#requirementconstraintmembership "Link to this heading")

`RequirementConstraintMembership` is defined in SysML specification on [page 390](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=390). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `RequirementConstraintMembership` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: RequirementConstraintMembership digraph { RequirementConstraintMembership \[label="RequirementConstraintMembership (SysML)" shape=plaintext\] FeatureMembership -\> RequirementConstraintMembership FeatureMembership \[label="FeatureMembership (KerML)" shape=plaintext\] OwningMembership -\> FeatureMembership OwningMembership \[label="OwningMembership (KerML)" shape=plaintext\] Membership -\> OwningMembership Membership \[label="Membership (KerML)" shape=plaintext\] Relationship -\> Membership Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-7e3184d0f191f7b0a25627e3e2e84cb5c4cec348.png)

</div>

</div>

The following table shows all attributes defined for `RequirementConstraintMembership` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`RequirementConstraintMembership`](#syside.RequirementConstraintMembership "syside.RequirementConstraintMembership"):

[`kind`](#syside.RequirementConstraintMembership.kind "syside.RequirementConstraintMembership.kind")

Whether the `RequirementConstraintMembership` is for an assumed or required `ConstraintUsage`.

[`owned_constraint`](#syside.RequirementConstraintMembership.owned_constraint "syside.RequirementConstraintMembership.owned_constraint")

The `ConstraintUsage` that is the `ownedMemberFeature` of this `RequirementConstraintMembership`.

[`referenced_constraint`](#syside.RequirementConstraintMembership.referenced_constraint "syside.RequirementConstraintMembership.referenced_constraint")
...
The following table lists Syside specific attributes available for class [`RequirementConstraintMembership`](#syside.RequirementConstraintMembership "syside.RequirementConstraintMembership"):
...
| ---------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                             |
| [`STD`](#syside.RequirementConstraintMembership.STD "syside.RequirementConstraintMembership.STD")                            |
| [`try_set_kind`](#syside.RequirementConstraintMembership.try_set_kind "syside.RequirementConstraintMembership.try_set_kind") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">RequirementConstraintMembership</span></span>[](#syside.RequirementConstraintMembership "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::RequirementConstraintMembership'</span>*[](#syside.RequirementConstraintMembership.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.RequirementConstraintMembership</span>](#syside.RequirementConstraintMembership "syside.RequirementConstraintMembership")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.RequirementConstraintMembership.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">kind</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RequirementConstraintKind</span>](/v0.8.1/api/metamodel/SysML/RequirementConstraintKind.md "syside.RequirementConstraintKind")*[](#syside.RequirementConstraintMembership.kind "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">try\_set\_kind</span></span><span class="sig-paren">(</span>*<span class="n"><span class="pre">arg</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n">[<span class="pre">syside.RequirementConstraintKind</span>](/v0.8.1/api/metamodel/SysML/RequirementConstraintKind.md "syside.RequirementConstraintKind")</span>*, *<span class="o"><span class="pre">/</span></span>*<span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">→</span> <span class="sig-return-typehint"><span class="pre">bool</span></span></span>[](#syside.RequirementConstraintMembership.try_set_kind "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_constraint</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ConstraintUsage</span>](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.RequirementConstraintMembership.owned_constraint "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referenced\_constraint</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ConstraintUsage</span>](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.RequirementConstraintMembership.referenced_constraint "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.RequirementConstraintMembership.owning_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_member\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.RequirementConstraintMembership.owned_member_feature "Link to this definition")
