<div id="attributedefinition" class="section">

<span id="metamodel-sysml-attributedefinition"></span>

# AttributeDefinition[](#attributedefinition "Link to this heading")

`AttributeDefinition` is defined in SysML specification on [page 312](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=312). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `AttributeDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: AttributeDefinition digraph { AttributeDefinition \[label="AttributeDefinition (SysML)" shape=plaintext\] Definition -\> AttributeDefinition DataType -\> AttributeDefinition Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition DataType \[label="DataType (KerML)" shape=plaintext\] Classifier -\> DataType Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-0a4bcd2e24434b93c9de310612a35519f56693bf.png)

</div>

</div>

The following table shows all attributes defined for `AttributeDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`AttributeDefinition`](#syside.AttributeDefinition "syside.AttributeDefinition"):
...
The following table lists Syside specific attributes available for class [`AttributeDefinition`](#syside.AttributeDefinition "syside.AttributeDefinition"):
...
| ------------------------------------------------------------------------- |
| Python Attribute                                                          |
| [`STD`](#syside.AttributeDefinition.STD "syside.AttributeDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AttributeDefinition</span></span>[](#syside.AttributeDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AttributeDefinition'</span>*[](#syside.AttributeDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AttributeDefinition</span>](#syside.AttributeDefinition "syside.AttributeDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AttributeDefinition.STD "Link to this definition")
