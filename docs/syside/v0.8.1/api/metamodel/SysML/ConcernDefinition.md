<div id="concerndefinition" class="section">

<span id="metamodel-sysml-concerndefinition"></span>

# ConcernDefinition[](#concerndefinition "Link to this heading")

`ConcernDefinition` is defined in SysML specification on [page 387](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=387). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ConcernDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ConcernDefinition digraph { ConcernDefinition \[label="ConcernDefinition (SysML)" shape=plaintext\] RequirementDefinition -\> ConcernDefinition RequirementDefinition \[label="RequirementDefinition (SysML)" shape=plaintext\] ConstraintDefinition -\> RequirementDefinition ConstraintDefinition \[label="ConstraintDefinition (SysML)" shape=plaintext\] OccurrenceDefinition -\> ConstraintDefinition Predicate -\> ConstraintDefinition OccurrenceDefinition \[label="OccurrenceDefinition (SysML)" shape=plaintext\] Definition -\> OccurrenceDefinition Class -\> OccurrenceDefinition Predicate \[label="Predicate (KerML)" shape=plaintext\] Function -\> Predicate Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition Class \[label="Class (KerML)" shape=plaintext\] Classifier -\> Class Function \[label="Function (KerML)" shape=plaintext\] Behavior -\> Function Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Behavior \[label="Behavior (KerML)" shape=plaintext\] Class -\> Behavior Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-2a2f5e7ad6150e79970a60720176ce4cd196ac13.png)

</div>

</div>

The following table shows all attributes defined for `ConcernDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ConcernDefinition`](#syside.ConcernDefinition "syside.ConcernDefinition"):
...
The following table lists Syside specific attributes available for class [`ConcernDefinition`](#syside.ConcernDefinition "syside.ConcernDefinition"):
...
| --------------------------------------------------------------------- |
| Python Attribute                                                      |
| [`STD`](#syside.ConcernDefinition.STD "syside.ConcernDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ConcernDefinition</span></span>[](#syside.ConcernDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ConcernDefinition'</span>*[](#syside.ConcernDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConcernDefinition</span>](#syside.ConcernDefinition "syside.ConcernDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ConcernDefinition.STD "Link to this definition")
