<div id="assertconstraintusage" class="section">

<span id="metamodel-sysml-assertconstraintusage"></span>

# AssertConstraintUsage[](#assertconstraintusage "Link to this heading")

`AssertConstraintUsage` is defined in SysML specification on [page 381](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=381). Excerpt from the machine readable specification:
...
Attributes defined in [`AssertConstraintUsage`](#syside.AssertConstraintUsage "syside.AssertConstraintUsage"):

[`asserted_constraint`](#syside.AssertConstraintUsage.asserted_constraint "syside.AssertConstraintUsage.asserted_constraint")
...
The following table lists Syside specific attributes available for class [`AssertConstraintUsage`](#syside.AssertConstraintUsage "syside.AssertConstraintUsage"):
...
| ----------------------------------------------------------------------------- |
| Python Attribute                                                              |
| [`STD`](#syside.AssertConstraintUsage.STD "syside.AssertConstraintUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AssertConstraintUsage</span></span>[](#syside.AssertConstraintUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AssertConstraintUsage'</span>*[](#syside.AssertConstraintUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">Union</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AssertConstraintUsage</span>](#syside.AssertConstraintUsage "syside.AssertConstraintUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">SatisfyRequirementUsage</span>](/v0.8.1/api/metamodel/SysML/SatisfyRequirementUsage.md "syside.SatisfyRequirementUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AssertConstraintUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">is\_negated</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span>*[](#syside.AssertConstraintUsage.is_negated "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">asserted\_constraint</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ConstraintUsage</span>](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.AssertConstraintUsage.asserted_constraint "Link to this definition")
