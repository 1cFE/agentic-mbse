<div id="eventoccurrenceusage" class="section">

<span id="metamodel-sysml-eventoccurrenceusage"></span>

# EventOccurrenceUsage[](#eventoccurrenceusage "Link to this heading")

`EventOccurrenceUsage` is defined in SysML specification on [page 316](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=316). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `EventOccurrenceUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: EventOccurrenceUsage digraph { EventOccurrenceUsage \[label="EventOccurrenceUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> EventOccurrenceUsage OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-9065ba486d18b7ffe5004a69f0a31172caeefdac.png)

</div>

</div>

The following table shows all attributes defined for `EventOccurrenceUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`EventOccurrenceUsage`](#syside.EventOccurrenceUsage "syside.EventOccurrenceUsage"):

[`event_occurrence`](#syside.EventOccurrenceUsage.event_occurrence "syside.EventOccurrenceUsage.event_occurrence")
...
The following table lists Syside specific attributes available for class [`EventOccurrenceUsage`](#syside.EventOccurrenceUsage "syside.EventOccurrenceUsage"):
...
| --------------------------------------------------------------------------- |
| Python Attribute                                                            |
| [`STD`](#syside.EventOccurrenceUsage.STD "syside.EventOccurrenceUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">EventOccurrenceUsage</span></span>[](#syside.EventOccurrenceUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::EventOccurrenceUsage'</span>*[](#syside.EventOccurrenceUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">Union</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.EventOccurrenceUsage</span>](#syside.EventOccurrenceUsage "syside.EventOccurrenceUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">ExhibitStateUsage</span>](/v0.8.1/api/metamodel/SysML/ExhibitStateUsage.md "syside.ExhibitStateUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">IncludeUseCaseUsage</span>](/v0.8.1/api/metamodel/SysML/IncludeUseCaseUsage.md "syside.IncludeUseCaseUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">PerformActionUsage</span>](/v0.8.1/api/metamodel/SysML/PerformActionUsage.md "syside.PerformActionUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.EventOccurrenceUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">event\_occurrence</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.OccurrenceUsage</span>](/v0.8.1/api/metamodel/SysML/OccurrenceUsage.md "syside.OccurrenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.EventOccurrenceUsage.event_occurrence "Link to this definition")
