<div id="enumerationdefinition" class="section">

<span id="metamodel-sysml-enumerationdefinition"></span>

# EnumerationDefinition[](#enumerationdefinition "Link to this heading")

`EnumerationDefinition` is defined in SysML specification on [page 314](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=314). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `EnumerationDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: EnumerationDefinition digraph { EnumerationDefinition \[label="EnumerationDefinition (SysML)" shape=plaintext\] AttributeDefinition -\> EnumerationDefinition AttributeDefinition \[label="AttributeDefinition (SysML)" shape=plaintext\] Definition -\> AttributeDefinition DataType -\> AttributeDefinition Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition DataType \[label="DataType (KerML)" shape=plaintext\] Classifier -\> DataType Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-5db3350bc3cd338b412d0709e3982c6d7f2dc966.png)

</div>

</div>

The following table shows all attributes defined for `EnumerationDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`EnumerationDefinition`](#syside.EnumerationDefinition "syside.EnumerationDefinition"):

[`enumerated_values`](#syside.EnumerationDefinition.enumerated_values "syside.EnumerationDefinition.enumerated_values")
...
Attributes defined in [`AttributeDefinition`](/v0.8.1/api/metamodel/SysML/AttributeDefinition.md "syside.AttributeDefinition"):
...
Attributes defined in [`DataType`](/v0.8.1/api/metamodel/KerML/DataType.md "syside.DataType"):
...
The following table lists Syside specific attributes available for class [`EnumerationDefinition`](#syside.EnumerationDefinition "syside.EnumerationDefinition"):
...
| ----------------------------------------------------------------------------- |
| Python Attribute                                                              |
| [`STD`](#syside.EnumerationDefinition.STD "syside.EnumerationDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">EnumerationDefinition</span></span>[](#syside.EnumerationDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::EnumerationDefinition'</span>*[](#syside.EnumerationDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.EnumerationDefinition</span>](#syside.EnumerationDefinition "syside.EnumerationDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.EnumerationDefinition.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">enumerated\_values</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.EnumerationUsage</span>](/v0.8.1/api/metamodel/SysML/EnumerationUsage.md "syside.EnumerationUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.EnumerationDefinition.enumerated_values "Link to this definition")
