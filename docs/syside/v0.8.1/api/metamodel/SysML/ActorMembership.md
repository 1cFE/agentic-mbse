<div id="actormembership" class="section">

<span id="metamodel-sysml-actormembership"></span>

# ActorMembership[](#actormembership "Link to this heading")

`ActorMembership` is defined in SysML specification on [page 387](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=387). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ActorMembership` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ActorMembership digraph { ActorMembership \[label="ActorMembership (SysML)" shape=plaintext\] ParameterMembership -\> ActorMembership ParameterMembership \[label="ParameterMembership (KerML)" shape=plaintext\] FeatureMembership -\> ParameterMembership FeatureMembership \[label="FeatureMembership (KerML)" shape=plaintext\] OwningMembership -\> FeatureMembership OwningMembership \[label="OwningMembership (KerML)" shape=plaintext\] Membership -\> OwningMembership Membership \[label="Membership (KerML)" shape=plaintext\] Relationship -\> Membership Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-335bf44584f8ccfc5f8a83a463e169d95ace5b0c.png)

</div>

</div>

The following table shows all attributes defined for `ActorMembership` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ActorMembership`](#syside.ActorMembership "syside.ActorMembership"):

[`owned_actor_parameter`](#syside.ActorMembership.owned_actor_parameter "syside.ActorMembership.owned_actor_parameter")
...
The following table lists Syside specific attributes available for class [`ActorMembership`](#syside.ActorMembership "syside.ActorMembership"):
...
| ----------------------------------------------------------------- |
| Python Attribute                                                  |
| [`STD`](#syside.ActorMembership.STD "syside.ActorMembership.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ActorMembership</span></span>[](#syside.ActorMembership "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ActorMembership'</span>*[](#syside.ActorMembership.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ActorMembership</span>](#syside.ActorMembership "syside.ActorMembership")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ActorMembership.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_actor\_parameter</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.PartUsage</span>](/v0.8.1/api/metamodel/SysML/PartUsage.md "syside.PartUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ActorMembership.owned_actor_parameter "Link to this definition")
