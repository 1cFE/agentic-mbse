<div id="membershipexpose" class="section">

<span id="metamodel-sysml-membershipexpose"></span>

# MembershipExpose[](#membershipexpose "Link to this heading")

`MembershipExpose` is defined in SysML specification on [page 418](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=418). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `MembershipExpose` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: MembershipExpose digraph { MembershipExpose \[label="MembershipExpose (SysML)" shape=plaintext\] MembershipImport -\> MembershipExpose Expose -\> MembershipExpose MembershipImport \[label="MembershipImport (KerML)" shape=plaintext\] Import -\> MembershipImport Expose \[label="Expose (SysML)" shape=plaintext\] Import -\> Expose Import \[label="Import (KerML)" shape=plaintext\] Relationship -\> Import Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-fecb3e758951a8f23c564ee50a65e019a131dfef.png)

</div>

</div>

The following table shows all attributes defined for `MembershipExpose` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`MembershipExpose`](#syside.MembershipExpose "syside.MembershipExpose"):

Attributes defined in [`MembershipImport`](/v0.8.1/api/metamodel/KerML/MembershipImport.md "syside.MembershipImport"):

[`imported_membership`](/v0.8.1/api/metamodel/KerML/MembershipImport.md "syside.MembershipImport.imported_membership")

The `Membership` to be imported.

Attributes defined in [`Expose`](/v0.8.1/api/metamodel/SysML/Expose.md "syside.Expose"):
...
The following table lists Syside specific attributes available for class [`MembershipExpose`](#syside.MembershipExpose "syside.MembershipExpose"):
...
| ------------------------------------------------------------------- |
| Python Attribute                                                    |
| [`STD`](#syside.MembershipExpose.STD "syside.MembershipExpose.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">MembershipExpose</span></span>[](#syside.MembershipExpose "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::MembershipExpose'</span>*[](#syside.MembershipExpose.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.MembershipExpose</span>](#syside.MembershipExpose "syside.MembershipExpose")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.MembershipExpose.STD "Link to this definition")
