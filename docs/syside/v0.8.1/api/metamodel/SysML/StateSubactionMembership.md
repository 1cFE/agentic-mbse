<div id="statesubactionmembership" class="section">

<span id="metamodel-sysml-statesubactionmembership"></span>

# StateSubactionMembership[](#statesubactionmembership "Link to this heading")

`StateSubactionMembership` is defined in SysML specification on [page 368](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=368). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `StateSubactionMembership` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: StateSubactionMembership digraph { StateSubactionMembership \[label="StateSubactionMembership (SysML)" shape=plaintext\] FeatureMembership -\> StateSubactionMembership FeatureMembership \[label="FeatureMembership (KerML)" shape=plaintext\] OwningMembership -\> FeatureMembership OwningMembership \[label="OwningMembership (KerML)" shape=plaintext\] Membership -\> OwningMembership Membership \[label="Membership (KerML)" shape=plaintext\] Relationship -\> Membership Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-ef72e28058370f277d9d27ca49c2d4f381c8558d.png)

</div>

</div>

The following table shows all attributes defined for `StateSubactionMembership` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`StateSubactionMembership`](#syside.StateSubactionMembership "syside.StateSubactionMembership"):

[`action`](#syside.StateSubactionMembership.action "syside.StateSubactionMembership.action")

The `ActionUsage` that is the `ownedMemberFeature` of this `StateSubactionMembership`.

[`kind`](#syside.StateSubactionMembership.kind "syside.StateSubactionMembership.kind")
...
The following table lists Syside specific attributes available for class [`StateSubactionMembership`](#syside.StateSubactionMembership "syside.StateSubactionMembership"):
...
| ----------------------------------------------------------------------------------- |
| Python Attribute                                                                    |
| [`STD`](#syside.StateSubactionMembership.STD "syside.StateSubactionMembership.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">StateSubactionMembership</span></span>[](#syside.StateSubactionMembership "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::StateSubactionMembership'</span>*[](#syside.StateSubactionMembership.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.StateSubactionMembership</span>](#syside.StateSubactionMembership "syside.StateSubactionMembership")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.StateSubactionMembership.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">kind</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.StateSubactionKind</span>](/v0.8.1/api/metamodel/SysML/StateSubactionKind.md "syside.StateSubactionKind")*[](#syside.StateSubactionMembership.kind "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">action</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.StateSubactionMembership.action "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.StateSubactionMembership.owning_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_member\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.StateSubactionMembership.owned_member_feature "Link to this definition")
