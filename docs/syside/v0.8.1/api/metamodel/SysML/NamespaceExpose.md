<div id="namespaceexpose" class="section">

<span id="metamodel-sysml-namespaceexpose"></span>

# NamespaceExpose[](#namespaceexpose "Link to this heading")

`NamespaceExpose` is defined in SysML specification on [page 419](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=419). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `NamespaceExpose` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: NamespaceExpose digraph { NamespaceExpose \[label="NamespaceExpose (SysML)" shape=plaintext\] NamespaceImport -\> NamespaceExpose Expose -\> NamespaceExpose NamespaceImport \[label="NamespaceImport (KerML)" shape=plaintext\] Import -\> NamespaceImport Expose \[label="Expose (SysML)" shape=plaintext\] Import -\> Expose Import \[label="Import (KerML)" shape=plaintext\] Relationship -\> Import Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-c43a625b6ca2b1744af78d1950f5ad54fdf73302.png)

</div>

</div>

The following table shows all attributes defined for `NamespaceExpose` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`NamespaceExpose`](#syside.NamespaceExpose "syside.NamespaceExpose"):

Attributes defined in [`NamespaceImport`](/v0.8.1/api/metamodel/KerML/NamespaceImport.md "syside.NamespaceImport"):

[`imported_namespace`](/v0.8.1/api/metamodel/KerML/NamespaceImport.md "syside.NamespaceImport.imported_namespace")
...
The following table lists Syside specific attributes available for class [`NamespaceExpose`](#syside.NamespaceExpose "syside.NamespaceExpose"):
...
| ----------------------------------------------------------------- |
| Python Attribute                                                  |
| [`STD`](#syside.NamespaceExpose.STD "syside.NamespaceExpose.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">NamespaceExpose</span></span>[](#syside.NamespaceExpose "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::NamespaceExpose'</span>*[](#syside.NamespaceExpose.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.NamespaceExpose</span>](#syside.NamespaceExpose "syside.NamespaceExpose")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.NamespaceExpose.STD "Link to this definition")
