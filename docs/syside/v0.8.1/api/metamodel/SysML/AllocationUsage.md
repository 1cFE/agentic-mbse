<div id="allocationusage" class="section">

<span id="metamodel-sysml-allocationusage"></span>

# AllocationUsage[](#allocationusage "Link to this heading")

`AllocationUsage` is defined in SysML specification on [page 337](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=337). Excerpt from the machine readable specification:
...
Attributes defined in [`AllocationUsage`](#syside.AllocationUsage "syside.AllocationUsage"):

[`allocation_definitions`](#syside.AllocationUsage.allocation_definitions "syside.AllocationUsage.allocation_definitions")
...
The following table lists Syside specific attributes available for class [`AllocationUsage`](#syside.AllocationUsage "syside.AllocationUsage"):
...
| ----------------------------------------------------------------- |
| Python Attribute                                                  |
| [`STD`](#syside.AllocationUsage.STD "syside.AllocationUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AllocationUsage</span></span>[](#syside.AllocationUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AllocationUsage'</span>*[](#syside.AllocationUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AllocationUsage</span>](#syside.AllocationUsage "syside.AllocationUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AllocationUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">allocation\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AllocationDefinition</span>](/v0.8.1/api/metamodel/SysML/AllocationDefinition.md "syside.AllocationDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.AllocationUsage.allocation_definitions "Link to this definition")
