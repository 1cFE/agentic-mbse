<div id="bindingconnectorasusage" class="section">

<span id="metamodel-sysml-bindingconnectorasusage"></span>

# BindingConnectorAsUsage[](#bindingconnectorasusage "Link to this heading")

`BindingConnectorAsUsage` is defined in SysML specification on [page 331](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=331). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `BindingConnectorAsUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: BindingConnectorAsUsage digraph { BindingConnectorAsUsage \[label="BindingConnectorAsUsage (SysML)" shape=plaintext\] ConnectorAsUsage -\> BindingConnectorAsUsage BindingConnector -\> BindingConnectorAsUsage ConnectorAsUsage \[label="ConnectorAsUsage (SysML)" shape=plaintext\] Usage -\> ConnectorAsUsage Connector -\> ConnectorAsUsage BindingConnector \[label="BindingConnector (KerML)" shape=plaintext\] Connector -\> BindingConnector Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Connector \[label="Connector (KerML)" shape=plaintext\] Feature -\> Connector Relationship -\> Connector Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Element \[label="Element (KerML)" shape=plaintext\] Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace }](_images/graphviz-2c1581883cb37f77ca3301a6ce16dac7a8826597.png)

</div>

</div>

The following table shows all attributes defined for `BindingConnectorAsUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`BindingConnectorAsUsage`](#syside.BindingConnectorAsUsage "syside.BindingConnectorAsUsage"):

Attributes defined in [`ConnectorAsUsage`](/v0.8.1/api/metamodel/SysML/ConnectorAsUsage.md "syside.ConnectorAsUsage"):

Attributes defined in [`BindingConnector`](/v0.8.1/api/metamodel/KerML/BindingConnector.md "syside.BindingConnector"):
...
The following table lists Syside specific attributes available for class [`BindingConnectorAsUsage`](#syside.BindingConnectorAsUsage "syside.BindingConnectorAsUsage"):
...
| --------------------------------------------------------------------------------- |
| Python Attribute                                                                  |
| [`STD`](#syside.BindingConnectorAsUsage.STD "syside.BindingConnectorAsUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">BindingConnectorAsUsage</span></span>[](#syside.BindingConnectorAsUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::BindingConnectorAsUsage'</span>*[](#syside.BindingConnectorAsUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.BindingConnectorAsUsage</span>](#syside.BindingConnectorAsUsage "syside.BindingConnectorAsUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.BindingConnectorAsUsage.STD "Link to this definition")
