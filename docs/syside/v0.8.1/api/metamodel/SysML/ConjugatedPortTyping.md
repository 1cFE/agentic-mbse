<div id="conjugatedporttyping" class="section">

<span id="metamodel-sysml-conjugatedporttyping"></span>

# ConjugatedPortTyping[](#conjugatedporttyping "Link to this heading")

`ConjugatedPortTyping` is defined in SysML specification on [page 326](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=326). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ConjugatedPortTyping` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ConjugatedPortTyping digraph { ConjugatedPortTyping \[label="ConjugatedPortTyping (SysML)" shape=plaintext\] FeatureTyping -\> ConjugatedPortTyping FeatureTyping \[label="FeatureTyping (KerML)" shape=plaintext\] Specialization -\> FeatureTyping Specialization \[label="Specialization (KerML)" shape=plaintext\] Relationship -\> Specialization Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-e210686e9707e5d59ac908ca30161c37fa00eb82.png)

</div>

</div>

The following table shows all attributes defined for `ConjugatedPortTyping` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ConjugatedPortTyping`](#syside.ConjugatedPortTyping "syside.ConjugatedPortTyping"):

[`conjugated_port_definition`](#syside.ConjugatedPortTyping.conjugated_port_definition "syside.ConjugatedPortTyping.conjugated_port_definition")

The `type` of this `ConjugatedPortTyping` considered as a `FeatureTyping`, which must be a `ConjugatedPortDefinition`.

[`port_definition`](#syside.ConjugatedPortTyping.port_definition "syside.ConjugatedPortTyping.port_definition")

The `originalPortDefinition` of the `conjugatedPortDefinition` of this `ConjugatedPortTyping`.

Attributes defined in [`FeatureTyping`](/v0.8.1/api/metamodel/KerML/FeatureTyping.md "syside.FeatureTyping"):

[`owning_feature`](/v0.8.1/api/metamodel/KerML/FeatureTyping.md "syside.FeatureTyping.owning_feature")

A `typedFeature` that is also the `owningRelatedElement` of this `FeatureTyping`.

[`type`](/v0.8.1/api/metamodel/KerML/FeatureTyping.md "syside.FeatureTyping.type")

The `Type` that is being applied by this `FeatureTyping`.

[`typed_feature`](/v0.8.1/api/metamodel/KerML/FeatureTyping.md "syside.FeatureTyping.typed_feature")
...
The following table lists Syside specific attributes available for class [`ConjugatedPortTyping`](#syside.ConjugatedPortTyping "syside.ConjugatedPortTyping"):
...
| --------------------------------------------------------------------------------------------- |
| Python Attribute                                                                              |
| [`CHAINABLE`](#syside.ConjugatedPortTyping.CHAINABLE "syside.ConjugatedPortTyping.CHAINABLE") |
| [`STD`](#syside.ConjugatedPortTyping.STD "syside.ConjugatedPortTyping.STD")                   |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ConjugatedPortTyping</span></span>[](#syside.ConjugatedPortTyping "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ConjugatedPortTyping'</span>*[](#syside.ConjugatedPortTyping.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConjugatedPortTyping</span>](#syside.ConjugatedPortTyping "syside.ConjugatedPortTyping")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ConjugatedPortTyping.STD "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">CHAINABLE</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">False</span>*[](#syside.ConjugatedPortTyping.CHAINABLE "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">port\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.PortDefinition</span>](/v0.8.1/api/metamodel/SysML/PortDefinition.md "syside.PortDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ConjugatedPortTyping.port_definition "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">conjugated\_port\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ConjugatedPortDefinition</span>](/v0.8.1/api/metamodel/SysML/ConjugatedPortDefinition.md "syside.ConjugatedPortDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ConjugatedPortTyping.conjugated_port_definition "Link to this definition")
