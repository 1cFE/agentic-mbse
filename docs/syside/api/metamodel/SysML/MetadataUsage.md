<div id="metadatausage" class="section">

<span id="metamodel-sysml-metadatausage"></span>

# MetadataUsage[](#metadatausage "Link to this heading")

`MetadataUsage` is defined in SysML specification on [page 428](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=428). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `MetadataUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: MetadataUsage digraph { MetadataUsage \[label="MetadataUsage (SysML)" shape=plaintext\] ItemUsage -\> MetadataUsage MetadataFeature -\> MetadataUsage ItemUsage \[label="ItemUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ItemUsage MetadataFeature \[label="MetadataFeature (KerML)" shape=plaintext\] Feature -\> MetadataFeature AnnotatingElement -\> MetadataFeature OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature AnnotatingElement \[label="AnnotatingElement (KerML)" shape=plaintext\] Element -\> AnnotatingElement Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Element \[label="Element (KerML)" shape=plaintext\] Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace }](_images/graphviz-8d8a5bdb17b5aca4c5d9c6a23216fc909cfe32dc.png)

</div>

</div>

The following table shows all attributes defined for `MetadataUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`MetadataUsage`](#syside.MetadataUsage "syside.MetadataUsage"):

[`metadata_definition`](#syside.MetadataUsage.metadata_definition "syside.MetadataUsage.metadata_definition")
...
Attributes defined in [`MetadataFeature`](/v0.8.1/api/metamodel/KerML/MetadataFeature.md "syside.MetadataFeature"):

[`metaclass`](/v0.8.1/api/metamodel/KerML/MetadataFeature.md "syside.MetadataFeature.metaclass")
...
The following table lists Syside specific attributes available for class [`MetadataUsage`](#syside.MetadataUsage "syside.MetadataUsage"):
...
| ------------------------------------------------------------------- |
| Python Attribute                                                    |
| [`STD`](#syside.MetadataUsage.STD "syside.MetadataUsage.STD")       |
| [`about`](#syside.MetadataUsage.about "syside.MetadataUsage.about") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">MetadataUsage</span></span>[](#syside.MetadataUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::MetadataUsage'</span>*[](#syside.MetadataUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.MetadataUsage</span>](#syside.MetadataUsage "syside.MetadataUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.MetadataUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">metadata\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.MetadataDefinition</span>](/v0.8.1/api/metamodel/SysML/MetadataDefinition.md "syside.MetadataDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.MetadataUsage.metadata_definition "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">annotations</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ContainerView</span>](/v0.8.1/api/generated/syside.ContainerView.md "syside.ContainerView")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Annotation</span>](/v0.8.1/api/metamodel/KerML/Annotation.md "syside.Annotation")<span class="p"><span class="pre">\]</span></span>*[](#syside.MetadataUsage.annotations "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">annotated\_elements</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ContainerView</span>](/v0.8.1/api/generated/syside.ContainerView.md "syside.ContainerView")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Element</span>](/v0.8.1/api/metamodel/KerML/Element.md "syside.Element")<span class="p"><span class="pre">\]</span></span>*[](#syside.MetadataUsage.annotated_elements "Link to this definition")
