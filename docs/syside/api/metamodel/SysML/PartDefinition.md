<div id="partdefinition" class="section">

<span id="metamodel-sysml-partdefinition"></span>

# PartDefinition[](#partdefinition "Link to this heading")

`PartDefinition` is defined in SysML specification on [page 323](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=323). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `PartDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: PartDefinition digraph { PartDefinition \[label="PartDefinition (SysML)" shape=plaintext\] ItemDefinition -\> PartDefinition ItemDefinition \[label="ItemDefinition (SysML)" shape=plaintext\] OccurrenceDefinition -\> ItemDefinition Structure -\> ItemDefinition OccurrenceDefinition \[label="OccurrenceDefinition (SysML)" shape=plaintext\] Definition -\> OccurrenceDefinition Class -\> OccurrenceDefinition Structure \[label="Structure (KerML)" shape=plaintext\] Class -\> Structure Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition Class \[label="Class (KerML)" shape=plaintext\] Classifier -\> Class Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-0b3a8fb9ffb9cbf049a18b036aa846d83688fbc6.png)

</div>

</div>

The following table shows all attributes defined for `PartDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`PartDefinition`](#syside.PartDefinition "syside.PartDefinition"):
...
The following table lists Syside specific attributes available for class [`PartDefinition`](#syside.PartDefinition "syside.PartDefinition"):
...
| --------------------------------------------------------------- |
| Python Attribute                                                |
| [`STD`](#syside.PartDefinition.STD "syside.PartDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">PartDefinition</span></span>[](#syside.PartDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::PartDefinition'</span>*[](#syside.PartDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.PartDefinition</span>](#syside.PartDefinition "syside.PartDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.PartDefinition.STD "Link to this definition")
