<div id="enumerationusage" class="section">

<span id="metamodel-sysml-enumerationusage"></span>

# EnumerationUsage[](#enumerationusage "Link to this heading")

`EnumerationUsage` is defined in SysML specification on [page 315](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=315). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `EnumerationUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: EnumerationUsage digraph { EnumerationUsage \[label="EnumerationUsage (SysML)" shape=plaintext\] AttributeUsage -\> EnumerationUsage AttributeUsage \[label="AttributeUsage (SysML)" shape=plaintext\] Usage -\> AttributeUsage Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-9d187a70de4bea4be8c67c80f8eda2a62d0ff4b1.png)

</div>

</div>

The following table shows all attributes defined for `EnumerationUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`EnumerationUsage`](#syside.EnumerationUsage "syside.EnumerationUsage"):

[`enumeration_definition`](#syside.EnumerationUsage.enumeration_definition "syside.EnumerationUsage.enumeration_definition")

The single EnumerationDefinition that is the type of this EnumerationUsage.

Attributes defined in [`AttributeUsage`](/v0.8.1/api/metamodel/SysML/AttributeUsage.md "syside.AttributeUsage"):

[`attribute_definitions`](/v0.8.1/api/metamodel/SysML/AttributeUsage.md "syside.AttributeUsage.attribute_definitions")
...
The following table lists Syside specific attributes available for class [`EnumerationUsage`](#syside.EnumerationUsage "syside.EnumerationUsage"):
...
| ------------------------------------------------------------------- |
| Python Attribute                                                    |
| [`STD`](#syside.EnumerationUsage.STD "syside.EnumerationUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">EnumerationUsage</span></span>[](#syside.EnumerationUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::EnumerationUsage'</span>*[](#syside.EnumerationUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.EnumerationUsage</span>](#syside.EnumerationUsage "syside.EnumerationUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.EnumerationUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">enumeration\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.EnumerationDefinition</span>](/v0.8.1/api/metamodel/SysML/EnumerationDefinition.md "syside.EnumerationDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.EnumerationUsage.enumeration_definition "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">attribute\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AttributeDefinition</span>](/v0.8.1/api/metamodel/SysML/AttributeDefinition.md "syside.AttributeDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.DataType</span>](/v0.8.1/api/metamodel/KerML/DataType.md "syside.DataType")<span class="p"><span class="pre">\]</span></span>*[](#syside.EnumerationUsage.attribute_definitions "Link to this definition")
