<div id="renderingusage" class="section">

<span id="metamodel-sysml-renderingusage"></span>

# RenderingUsage[](#renderingusage "Link to this heading")

`RenderingUsage` is defined in SysML specification on [page 420](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=420). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `RenderingUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: RenderingUsage digraph { RenderingUsage \[label="RenderingUsage (SysML)" shape=plaintext\] PartUsage -\> RenderingUsage PartUsage \[label="PartUsage (SysML)" shape=plaintext\] ItemUsage -\> PartUsage ItemUsage \[label="ItemUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ItemUsage OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-d1b61b7b3a299bdcc9769b2a542cf8a862f04d01.png)

</div>

</div>

The following table shows all attributes defined for `RenderingUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`RenderingUsage`](#syside.RenderingUsage "syside.RenderingUsage"):

[`rendering_definition`](#syside.RenderingUsage.rendering_definition "syside.RenderingUsage.rendering_definition")
...
The following table lists Syside specific attributes available for class [`RenderingUsage`](#syside.RenderingUsage "syside.RenderingUsage"):
...
| --------------------------------------------------------------- |
| Python Attribute                                                |
| [`STD`](#syside.RenderingUsage.STD "syside.RenderingUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">RenderingUsage</span></span>[](#syside.RenderingUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::RenderingUsage'</span>*[](#syside.RenderingUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.RenderingUsage</span>](#syside.RenderingUsage "syside.RenderingUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.RenderingUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">rendering\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RenderingDefinition</span>](/v0.8.1/api/metamodel/SysML/RenderingDefinition.md "syside.RenderingDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.RenderingUsage.rendering_definition "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">part\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.PartDefinition</span>](/v0.8.1/api/metamodel/SysML/PartDefinition.md "syside.PartDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.RenderingUsage.part_definitions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">item\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Structure</span>](/v0.8.1/api/metamodel/KerML/Structure.md "syside.Structure")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.AssociationStructure</span>](/v0.8.1/api/metamodel/KerML/AssociationStructure.md "syside.AssociationStructure")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ConnectionDefinition</span>](/v0.8.1/api/metamodel/SysML/ConnectionDefinition.md "syside.ConnectionDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ItemDefinition</span>](/v0.8.1/api/metamodel/SysML/ItemDefinition.md "syside.ItemDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.PortDefinition</span>](/v0.8.1/api/metamodel/SysML/PortDefinition.md "syside.PortDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.RenderingUsage.item_definitions "Link to this definition")
