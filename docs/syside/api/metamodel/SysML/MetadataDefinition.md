<div id="metadatadefinition" class="section">

<span id="metamodel-sysml-metadatadefinition"></span>

# MetadataDefinition[](#metadatadefinition "Link to this heading")

`MetadataDefinition` is defined in SysML specification on [page 427](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=427). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `MetadataDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: MetadataDefinition digraph { MetadataDefinition \[label="MetadataDefinition (SysML)" shape=plaintext\] ItemDefinition -\> MetadataDefinition Metaclass -\> MetadataDefinition ItemDefinition \[label="ItemDefinition (SysML)" shape=plaintext\] OccurrenceDefinition -\> ItemDefinition Structure -\> ItemDefinition Metaclass \[label="Metaclass (KerML)" shape=plaintext\] Structure -\> Metaclass OccurrenceDefinition \[label="OccurrenceDefinition (SysML)" shape=plaintext\] Definition -\> OccurrenceDefinition Class -\> OccurrenceDefinition Structure \[label="Structure (KerML)" shape=plaintext\] Class -\> Structure Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition Class \[label="Class (KerML)" shape=plaintext\] Classifier -\> Class Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-fb3dcb8e9b36233d80ee5385d56d564ea7aad755.png)

</div>

</div>

The following table shows all attributes defined for `MetadataDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`MetadataDefinition`](#syside.MetadataDefinition "syside.MetadataDefinition"):

Attributes defined in [`ItemDefinition`](/v0.8.1/api/metamodel/SysML/ItemDefinition.md "syside.ItemDefinition"):

Attributes defined in [`Metaclass`](/v0.8.1/api/metamodel/KerML/Metaclass.md "syside.Metaclass"):
...
The following table lists Syside specific attributes available for class [`MetadataDefinition`](#syside.MetadataDefinition "syside.MetadataDefinition"):
...
| ----------------------------------------------------------------------- |
| Python Attribute                                                        |
| [`STD`](#syside.MetadataDefinition.STD "syside.MetadataDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">MetadataDefinition</span></span>[](#syside.MetadataDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::MetadataDefinition'</span>*[](#syside.MetadataDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.MetadataDefinition</span>](#syside.MetadataDefinition "syside.MetadataDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.MetadataDefinition.STD "Link to this definition")
