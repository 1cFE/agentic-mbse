<div id="allocationdefinition" class="section">

<span id="metamodel-sysml-allocationdefinition"></span>

# AllocationDefinition[](#allocationdefinition "Link to this heading")

`AllocationDefinition` is defined in SysML specification on [page 336](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=336). Excerpt from the machine readable specification:
...
Attributes defined in [`AllocationDefinition`](#syside.AllocationDefinition "syside.AllocationDefinition"):

[`allocations`](#syside.AllocationDefinition.allocations "syside.AllocationDefinition.allocations")
...
The following table lists Syside specific attributes available for class [`AllocationDefinition`](#syside.AllocationDefinition "syside.AllocationDefinition"):
...
| --------------------------------------------------------------------------- |
| Python Attribute                                                            |
| [`STD`](#syside.AllocationDefinition.STD "syside.AllocationDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AllocationDefinition</span></span>[](#syside.AllocationDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AllocationDefinition'</span>*[](#syside.AllocationDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AllocationDefinition</span>](#syside.AllocationDefinition "syside.AllocationDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AllocationDefinition.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">allocations</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AllocationUsage</span>](/v0.8.1/api/metamodel/SysML/AllocationUsage.md "syside.AllocationUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.AllocationDefinition.allocations "Link to this definition")
