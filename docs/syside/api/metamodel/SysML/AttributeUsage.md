<div id="attributeusage" class="section">

<span id="metamodel-sysml-attributeusage"></span>

# AttributeUsage[](#attributeusage "Link to this heading")

`AttributeUsage` is defined in SysML specification on [page 312](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=312). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `AttributeUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: AttributeUsage digraph { AttributeUsage \[label="AttributeUsage (SysML)" shape=plaintext\] Usage -\> AttributeUsage Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-de82935dd12391eaf98ffc266614a2cc8014fef2.png)

</div>

</div>

The following table shows all attributes defined for `AttributeUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`AttributeUsage`](#syside.AttributeUsage "syside.AttributeUsage"):

[`attribute_definitions`](#syside.AttributeUsage.attribute_definitions "syside.AttributeUsage.attribute_definitions")
...
The following table lists Syside specific attributes available for class [`AttributeUsage`](#syside.AttributeUsage "syside.AttributeUsage"):
...
| --------------------------------------------------------------- |
| Python Attribute                                                |
| [`STD`](#syside.AttributeUsage.STD "syside.AttributeUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AttributeUsage</span></span>[](#syside.AttributeUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AttributeUsage'</span>*[](#syside.AttributeUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AttributeUsage</span>](#syside.AttributeUsage "syside.AttributeUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AttributeUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">attribute\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AttributeDefinition</span>](/v0.8.1/api/metamodel/SysML/AttributeDefinition.md "syside.AttributeDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.DataType</span>](/v0.8.1/api/metamodel/KerML/DataType.md "syside.DataType")<span class="p"><span class="pre">\]</span></span>*[](#syside.AttributeUsage.attribute_definitions "Link to this definition")
