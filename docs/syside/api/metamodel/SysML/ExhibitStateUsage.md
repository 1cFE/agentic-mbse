<div id="exhibitstateusage" class="section">

<span id="metamodel-sysml-exhibitstateusage"></span>

# ExhibitStateUsage[](#exhibitstateusage "Link to this heading")

`ExhibitStateUsage` is defined in SysML specification on [page 366](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=366). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ExhibitStateUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ExhibitStateUsage digraph { ExhibitStateUsage \[label="ExhibitStateUsage (SysML)" shape=plaintext\] StateUsage -\> ExhibitStateUsage PerformActionUsage -\> ExhibitStateUsage StateUsage \[label="StateUsage (SysML)" shape=plaintext\] ActionUsage -\> StateUsage PerformActionUsage \[label="PerformActionUsage (SysML)" shape=plaintext\] ActionUsage -\> PerformActionUsage EventOccurrenceUsage -\> PerformActionUsage ActionUsage \[label="ActionUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ActionUsage Step -\> ActionUsage EventOccurrenceUsage \[label="EventOccurrenceUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> EventOccurrenceUsage OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-a3bddf8ab509433243679d3708b72074499f49bb.png)

</div>

</div>

The following table shows all attributes defined for `ExhibitStateUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ExhibitStateUsage`](#syside.ExhibitStateUsage "syside.ExhibitStateUsage"):

[`exhibited_state`](#syside.ExhibitStateUsage.exhibited_state "syside.ExhibitStateUsage.exhibited_state")
...
Attributes defined in [`StateUsage`](/v0.8.1/api/metamodel/SysML/StateUsage.md "syside.StateUsage"):

[`do_action`](/v0.8.1/api/metamodel/SysML/StateUsage.md "syside.StateUsage.do_action")
...
[`entry_action`](/v0.8.1/api/metamodel/SysML/StateUsage.md "syside.StateUsage.entry_action")
...
[`exit_action`](/v0.8.1/api/metamodel/SysML/StateUsage.md "syside.StateUsage.exit_action")
...
[`is_parallel`](/v0.8.1/api/metamodel/SysML/StateUsage.md "syside.StateUsage.is_parallel")
...
[`state_definitions`](/v0.8.1/api/metamodel/SysML/StateUsage.md "syside.StateUsage.state_definitions")
...
The following table lists Syside specific attributes available for class [`ExhibitStateUsage`](#syside.ExhibitStateUsage "syside.ExhibitStateUsage"):
...
| --------------------------------------------------------------------- |
| Python Attribute                                                      |
| [`STD`](#syside.ExhibitStateUsage.STD "syside.ExhibitStateUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ExhibitStateUsage</span></span>[](#syside.ExhibitStateUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ExhibitStateUsage'</span>*[](#syside.ExhibitStateUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ExhibitStateUsage</span>](#syside.ExhibitStateUsage "syside.ExhibitStateUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ExhibitStateUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">exhibited\_state</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.StateUsage</span>](/v0.8.1/api/metamodel/SysML/StateUsage.md "syside.StateUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ExhibitStateUsage.exhibited_state "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">event\_occurrence</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.OccurrenceUsage</span>](/v0.8.1/api/metamodel/SysML/OccurrenceUsage.md "syside.OccurrenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ExhibitStateUsage.event_occurrence "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">performed\_action</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ExhibitStateUsage.performed_action "Link to this definition")
