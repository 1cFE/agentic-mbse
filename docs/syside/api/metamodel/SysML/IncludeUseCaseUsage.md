<div id="includeusecaseusage" class="section">

<span id="metamodel-sysml-includeusecaseusage"></span>

# IncludeUseCaseUsage[](#includeusecaseusage "Link to this heading")

`IncludeUseCaseUsage` is defined in SysML specification on [page 412](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=412). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `IncludeUseCaseUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: IncludeUseCaseUsage digraph { IncludeUseCaseUsage \[label="IncludeUseCaseUsage (SysML)" shape=plaintext\] UseCaseUsage -\> IncludeUseCaseUsage PerformActionUsage -\> IncludeUseCaseUsage UseCaseUsage \[label="UseCaseUsage (SysML)" shape=plaintext\] CaseUsage -\> UseCaseUsage PerformActionUsage \[label="PerformActionUsage (SysML)" shape=plaintext\] ActionUsage -\> PerformActionUsage EventOccurrenceUsage -\> PerformActionUsage CaseUsage \[label="CaseUsage (SysML)" shape=plaintext\] CalculationUsage -\> CaseUsage ActionUsage \[label="ActionUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ActionUsage Step -\> ActionUsage EventOccurrenceUsage \[label="EventOccurrenceUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> EventOccurrenceUsage CalculationUsage \[label="CalculationUsage (SysML)" shape=plaintext\] ActionUsage -\> CalculationUsage Expression -\> CalculationUsage OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Expression \[label="Expression (KerML)" shape=plaintext\] Step -\> Expression Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-4c1bd96ca6d595bc0ee3dda236ddbc353d33f05e.png)

</div>

</div>

The following table shows all attributes defined for `IncludeUseCaseUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`IncludeUseCaseUsage`](#syside.IncludeUseCaseUsage "syside.IncludeUseCaseUsage"):

[`use_case_included`](#syside.IncludeUseCaseUsage.use_case_included "syside.IncludeUseCaseUsage.use_case_included")
...
Attributes defined in [`UseCaseUsage`](/v0.8.1/api/metamodel/SysML/UseCaseUsage.md "syside.UseCaseUsage"):

[`included_use_cases`](/v0.8.1/api/metamodel/SysML/UseCaseUsage.md "syside.UseCaseUsage.included_use_cases")
...
[`use_case_definition`](/v0.8.1/api/metamodel/SysML/UseCaseUsage.md "syside.UseCaseUsage.use_case_definition")

The `UseCaseDefinition` that is the `definition` of this `UseCaseUsage`.

Attributes defined in [`PerformActionUsage`](/v0.8.1/api/metamodel/SysML/PerformActionUsage.md "syside.PerformActionUsage"):

[`performed_action`](/v0.8.1/api/metamodel/SysML/PerformActionUsage.md "syside.PerformActionUsage.performed_action")
...
Attributes defined in [`EventOccurrenceUsage`](/v0.8.1/api/metamodel/SysML/EventOccurrenceUsage.md "syside.EventOccurrenceUsage"):

[`event_occurrence`](/v0.8.1/api/metamodel/SysML/EventOccurrenceUsage.md "syside.EventOccurrenceUsage.event_occurrence")
...
The following table lists Syside specific attributes available for class [`IncludeUseCaseUsage`](#syside.IncludeUseCaseUsage "syside.IncludeUseCaseUsage"):
...
| ------------------------------------------------------------------------- |
| Python Attribute                                                          |
| [`STD`](#syside.IncludeUseCaseUsage.STD "syside.IncludeUseCaseUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">IncludeUseCaseUsage</span></span>[](#syside.IncludeUseCaseUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::IncludeUseCaseUsage'</span>*[](#syside.IncludeUseCaseUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.IncludeUseCaseUsage</span>](#syside.IncludeUseCaseUsage "syside.IncludeUseCaseUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.IncludeUseCaseUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">use\_case\_included</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.UseCaseUsage</span>](/v0.8.1/api/metamodel/SysML/UseCaseUsage.md "syside.UseCaseUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.IncludeUseCaseUsage.use_case_included "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">event\_occurrence</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.OccurrenceUsage</span>](/v0.8.1/api/metamodel/SysML/OccurrenceUsage.md "syside.OccurrenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.IncludeUseCaseUsage.event_occurrence "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">performed\_action</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.IncludeUseCaseUsage.performed_action "Link to this definition")
