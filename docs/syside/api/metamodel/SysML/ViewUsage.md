<div id="viewusage" class="section">

<span id="metamodel-sysml-viewusage"></span>

# ViewUsage[](#viewusage "Link to this heading")

`ViewUsage` is defined in SysML specification on [page 425](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=425). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ViewUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ViewUsage digraph { ViewUsage \[label="ViewUsage (SysML)" shape=plaintext\] PartUsage -\> ViewUsage PartUsage \[label="PartUsage (SysML)" shape=plaintext\] ItemUsage -\> PartUsage ItemUsage \[label="ItemUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ItemUsage OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-cf8a6fd2fa0e646962e9fa4f071811f72678bd69.png)

</div>

</div>

The following table shows all attributes defined for `ViewUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ViewUsage`](#syside.ViewUsage "syside.ViewUsage"):

[`exposed_elements`](#syside.ViewUsage.exposed_elements "syside.ViewUsage.exposed_elements")
...
[`satisfied_viewpoints`](#syside.ViewUsage.satisfied_viewpoints "syside.ViewUsage.satisfied_viewpoints")

The `nestedRequirements` of this `ViewUsage` that are `ViewpointUsages` for (additional) viewpoints satisfied by the `ViewUsage`.

[`view_conditions`](#syside.ViewUsage.view_conditions "syside.ViewUsage.view_conditions")
...
[`view_definition`](#syside.ViewUsage.view_definition "syside.ViewUsage.view_definition")
...
The following table lists Syside specific attributes available for class [`ViewUsage`](#syside.ViewUsage "syside.ViewUsage"):
...
| ----------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                            |
| [`STD`](#syside.ViewUsage.STD "syside.ViewUsage.STD")                                                       |
| [`owned_view_conditions`](#syside.ViewUsage.owned_view_conditions "syside.ViewUsage.owned_view_conditions") |
| [`view_rendering`](#syside.ViewUsage.view_rendering "syside.ViewUsage.view_rendering")                      |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ViewUsage</span></span>[](#syside.ViewUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ViewUsage'</span>*[](#syside.ViewUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ViewUsage</span>](#syside.ViewUsage "syside.ViewUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ViewUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">view\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ViewDefinition</span>](/v0.8.1/api/metamodel/SysML/ViewDefinition.md "syside.ViewDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ViewUsage.view_definition "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">satisfied\_viewpoints</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ViewpointUsage</span>](/v0.8.1/api/metamodel/SysML/ViewpointUsage.md "syside.ViewpointUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewUsage.satisfied_viewpoints "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">exposed\_elements</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Element</span>](/v0.8.1/api/metamodel/KerML/Element.md "syside.Element")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewUsage.exposed_elements "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_view\_conditions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ElementFilterMembership</span>](/v0.8.1/api/metamodel/KerML/ElementFilterMembership.md "syside.ElementFilterMembership")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewUsage.owned_view_conditions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">view\_conditions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ElementFilterMembership</span>](/v0.8.1/api/metamodel/KerML/ElementFilterMembership.md "syside.ElementFilterMembership")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewUsage.view_conditions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">view\_rendering</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RenderingUsage</span>](/v0.8.1/api/metamodel/SysML/RenderingUsage.md "syside.RenderingUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ViewUsage.view_rendering "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">part\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.PartDefinition</span>](/v0.8.1/api/metamodel/SysML/PartDefinition.md "syside.PartDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewUsage.part_definitions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">item\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Structure</span>](/v0.8.1/api/metamodel/KerML/Structure.md "syside.Structure")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.AssociationStructure</span>](/v0.8.1/api/metamodel/KerML/AssociationStructure.md "syside.AssociationStructure")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ConnectionDefinition</span>](/v0.8.1/api/metamodel/SysML/ConnectionDefinition.md "syside.ConnectionDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ItemDefinition</span>](/v0.8.1/api/metamodel/SysML/ItemDefinition.md "syside.ItemDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.PortDefinition</span>](/v0.8.1/api/metamodel/SysML/PortDefinition.md "syside.PortDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewUsage.item_definitions "Link to this definition")
