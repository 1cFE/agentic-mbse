<div id="concernusage" class="section">

<span id="metamodel-sysml-concernusage"></span>

# ConcernUsage[](#concernusage "Link to this heading")

`ConcernUsage` is defined in SysML specification on [page 388](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=388). Excerpt from the machine readable specification:
...
Attributes defined in [`ConcernUsage`](#syside.ConcernUsage "syside.ConcernUsage"):

[`concern_definition`](#syside.ConcernUsage.concern_definition "syside.ConcernUsage.concern_definition")
...
The following table lists Syside specific attributes available for class [`ConcernUsage`](#syside.ConcernUsage "syside.ConcernUsage"):
...
| ----------------------------------------------------------- |
| Python Attribute                                            |
| [`STD`](#syside.ConcernUsage.STD "syside.ConcernUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ConcernUsage</span></span>[](#syside.ConcernUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ConcernUsage'</span>*[](#syside.ConcernUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConcernUsage</span>](#syside.ConcernUsage "syside.ConcernUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ConcernUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">concern\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ConcernDefinition</span>](/v0.8.1/api/metamodel/SysML/ConcernDefinition.md "syside.ConcernDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ConcernUsage.concern_definition "Link to this definition")
