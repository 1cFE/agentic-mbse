<div id="viewrenderingmembership" class="section">

<span id="metamodel-sysml-viewrenderingmembership"></span>

# ViewRenderingMembership[](#viewrenderingmembership "Link to this heading")

`ViewRenderingMembership` is defined in SysML specification on [page 424](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=424). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ViewRenderingMembership` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ViewRenderingMembership digraph { ViewRenderingMembership \[label="ViewRenderingMembership (SysML)" shape=plaintext\] FeatureMembership -\> ViewRenderingMembership FeatureMembership \[label="FeatureMembership (KerML)" shape=plaintext\] OwningMembership -\> FeatureMembership OwningMembership \[label="OwningMembership (KerML)" shape=plaintext\] Membership -\> OwningMembership Membership \[label="Membership (KerML)" shape=plaintext\] Relationship -\> Membership Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-fef0a520bfd64116c95a03cf81acdf81d0b03f02.png)

</div>

</div>

The following table shows all attributes defined for `ViewRenderingMembership` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ViewRenderingMembership`](#syside.ViewRenderingMembership "syside.ViewRenderingMembership"):

[`owned_rendering`](#syside.ViewRenderingMembership.owned_rendering "syside.ViewRenderingMembership.owned_rendering")

The owned `RenderingUsage` that is either itself the `referencedRendering` or subsets the `referencedRendering`.

[`referenced_rendering`](#syside.ViewRenderingMembership.referenced_rendering "syside.ViewRenderingMembership.referenced_rendering")
...
The following table lists Syside specific attributes available for class [`ViewRenderingMembership`](#syside.ViewRenderingMembership "syside.ViewRenderingMembership"):
...
| --------------------------------------------------------------------------------- |
| Python Attribute                                                                  |
| [`STD`](#syside.ViewRenderingMembership.STD "syside.ViewRenderingMembership.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ViewRenderingMembership</span></span>[](#syside.ViewRenderingMembership "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ViewRenderingMembership'</span>*[](#syside.ViewRenderingMembership.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ViewRenderingMembership</span>](#syside.ViewRenderingMembership "syside.ViewRenderingMembership")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ViewRenderingMembership.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_rendering</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RenderingUsage</span>](/v0.8.1/api/metamodel/SysML/RenderingUsage.md "syside.RenderingUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ViewRenderingMembership.owned_rendering "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">referenced\_rendering</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RenderingUsage</span>](/v0.8.1/api/metamodel/SysML/RenderingUsage.md "syside.RenderingUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ViewRenderingMembership.referenced_rendering "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ViewRenderingMembership.owning_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_member\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ViewRenderingMembership.owned_member_feature "Link to this definition")
