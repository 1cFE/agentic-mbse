<div id="satisfyrequirementusage" class="section">

<span id="metamodel-sysml-satisfyrequirementusage"></span>

# SatisfyRequirementUsage[](#satisfyrequirementusage "Link to this heading")

`SatisfyRequirementUsage` is defined in SysML specification on [page 397](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=397). Excerpt from the machine readable specification:
...
![// Class: SatisfyRequirementUsage digraph { SatisfyRequirementUsage \[label="SatisfyRequirementUsage (SysML)" shape=plaintext\] RequirementUsage -\> SatisfyRequirementUsage AssertConstraintUsage -\> SatisfyRequirementUsage RequirementUsage \[label="RequirementUsage (SysML)" shape=plaintext\] ConstraintUsage -\> RequirementUsage AssertConstraintUsage \[label="AssertConstraintUsage (SysML)" shape=plaintext\] ConstraintUsage -\> AssertConstraintUsage Invariant -\> AssertConstraintUsage ConstraintUsage \[label="ConstraintUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ConstraintUsage BooleanExpression -\> ConstraintUsage Invariant \[label="Invariant (KerML)" shape=plaintext\] BooleanExpression -\> Invariant OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage BooleanExpression \[label="BooleanExpression (KerML)" shape=plaintext\] Expression -\> BooleanExpression Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Expression \[label="Expression (KerML)" shape=plaintext\] Step -\> Expression Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-49181ef1d1f314bcc7970e6eb74574e8b3d0d490.png)
...
Attributes defined in [`SatisfyRequirementUsage`](#syside.SatisfyRequirementUsage "syside.SatisfyRequirementUsage"):

[`satisfied_requirement`](#syside.SatisfyRequirementUsage.satisfied_requirement "syside.SatisfyRequirementUsage.satisfied_requirement")
...
[`satisfying_feature`](#syside.SatisfyRequirementUsage.satisfying_feature "syside.SatisfyRequirementUsage.satisfying_feature")
...
Attributes defined in [`RequirementUsage`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage"):

[`actor_parameters`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.actor_parameters")

The `parameters` of this `RequirementUsage` that represent actors involved in the requirement.

[`assumed_constraints`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.assumed_constraints")
...
[`framed_concerns`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.framed_concerns")
...
[`req_id`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.req_id")
...
[`required_constraints`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.required_constraints")
...
[`requirement_definition`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.requirement_definition")

The `RequirementDefinition` that is the single `definition` of this `RequirementUsage`.

[`stakeholder_parameters`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.stakeholder_parameters")

The `parameters` of this `RequirementUsage` that represent stakeholders for the requirement.

[`subject_parameter`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.subject_parameter")

The `parameter` of this `RequirementUsage` that represents its subject.

[`texts`](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage.texts")
...
Attributes defined in [`AssertConstraintUsage`](/v0.8.1/api/metamodel/SysML/AssertConstraintUsage.md "syside.AssertConstraintUsage"):

[`asserted_constraint`](/v0.8.1/api/metamodel/SysML/AssertConstraintUsage.md "syside.AssertConstraintUsage.asserted_constraint")
...
Attributes defined in [`ConstraintUsage`](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage"):

[`constraint_definition`](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage.constraint_definition")
...
Attributes defined in [`Invariant`](/v0.8.1/api/metamodel/KerML/Invariant.md "syside.Invariant"):

[`is_negated`](/v0.8.1/api/metamodel/KerML/Invariant.md "syside.Invariant.is_negated")
...
Attributes defined in [`BooleanExpression`](/v0.8.1/api/metamodel/KerML/BooleanExpression.md "syside.BooleanExpression"):

[`predicate`](/v0.8.1/api/metamodel/KerML/BooleanExpression.md "syside.BooleanExpression.predicate")
...
The following table lists Syside specific attributes available for class [`SatisfyRequirementUsage`](#syside.SatisfyRequirementUsage "syside.SatisfyRequirementUsage"):
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                                                          |
| [`STD`](#syside.SatisfyRequirementUsage.STD "syside.SatisfyRequirementUsage.STD")                                                                         |
| [`satisfaction_subject`](#syside.SatisfyRequirementUsage.satisfaction_subject "syside.SatisfyRequirementUsage.satisfaction_subject")                      |
| [`satisfaction_subject_member`](#syside.SatisfyRequirementUsage.satisfaction_subject_member "syside.SatisfyRequirementUsage.satisfaction_subject_member") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">SatisfyRequirementUsage</span></span>[](#syside.SatisfyRequirementUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::SatisfyRequirementUsage'</span>*[](#syside.SatisfyRequirementUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.SatisfyRequirementUsage</span>](#syside.SatisfyRequirementUsage "syside.SatisfyRequirementUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.SatisfyRequirementUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">satisfied\_requirement</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RequirementUsage</span>](/v0.8.1/api/metamodel/SysML/RequirementUsage.md "syside.RequirementUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.satisfied_requirement "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">satisfying\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.satisfying_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">satisfaction\_subject\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.SatisfactionSubjectAccessor</span>](/v0.8.1/api/generated/syside.SatisfactionSubjectAccessor.md "syside.SatisfactionSubjectAccessor")*[](#syside.SatisfyRequirementUsage.satisfaction_subject_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">satisfaction\_subject</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceUsage</span>](/v0.8.1/api/metamodel/SysML/ReferenceUsage.md "syside.ReferenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.satisfaction_subject "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">is\_negated</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span>*[](#syside.SatisfyRequirementUsage.is_negated "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">asserted\_constraint</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ConstraintUsage</span>](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.asserted_constraint "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">requirement\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RequirementDefinition</span>](/v0.8.1/api/metamodel/SysML/RequirementDefinition.md "syside.RequirementDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.requirement_definition "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">subject\_parameter</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Usage</span>](/v0.8.1/api/metamodel/SysML/Usage.md "syside.Usage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.subject_parameter "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">actor\_parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.PartUsage</span>](/v0.8.1/api/metamodel/SysML/PartUsage.md "syside.PartUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.actor_parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">req\_id</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.req_id "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">texts</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span><span class="pre">str</span><span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.texts "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">stakeholder\_parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.PartUsage</span>](/v0.8.1/api/metamodel/SysML/PartUsage.md "syside.PartUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.stakeholder_parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">assumed\_constraints</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConstraintUsage</span>](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.assumed_constraints "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">required\_constraints</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConstraintUsage</span>](/v0.8.1/api/metamodel/SysML/ConstraintUsage.md "syside.ConstraintUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.required_constraints "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">framed\_concerns</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConcernUsage</span>](/v0.8.1/api/metamodel/SysML/ConcernUsage.md "syside.ConcernUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.framed_concerns "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">constraint\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ConstraintDefinition</span>](/v0.8.1/api/metamodel/SysML/ConstraintDefinition.md "syside.ConstraintDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.Predicate</span>](/v0.8.1/api/metamodel/KerML/Predicate.md "syside.Predicate")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.constraint_definition "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">behaviors</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Behavior</span>](/v0.8.1/api/metamodel/KerML/Behavior.md "syside.Behavior")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ActionDefinition</span>](/v0.8.1/api/metamodel/SysML/ActionDefinition.md "syside.ActionDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.behaviors "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.owned_parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.SatisfyRequirementUsage.parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">is\_model\_level\_evaluable</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span>*[](#syside.SatisfyRequirementUsage.is_model_level_evaluable "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">function</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Function</span>](/v0.8.1/api/metamodel/KerML/Function.md "syside.Function")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.CalculationDefinition</span>](/v0.8.1/api/metamodel/SysML/CalculationDefinition.md "syside.CalculationDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ConstraintDefinition</span>](/v0.8.1/api/metamodel/SysML/ConstraintDefinition.md "syside.ConstraintDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.function "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">result</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.result "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">predicate</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Predicate</span>](/v0.8.1/api/metamodel/KerML/Predicate.md "syside.Predicate")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ConstraintDefinition</span>](/v0.8.1/api/metamodel/SysML/ConstraintDefinition.md "syside.ConstraintDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.predicate "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">result\_expression</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Expression</span>](/v0.8.1/api/metamodel/KerML/Expression.md "syside.Expression")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.SatisfyRequirementUsage.result_expression "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">result\_expression\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ResultExpressionAccessor</span>](/v0.8.1/api/generated/syside.ResultExpressionAccessor.md "syside.ResultExpressionAccessor")*[](#syside.SatisfyRequirementUsage.result_expression_member "Link to this definition")
