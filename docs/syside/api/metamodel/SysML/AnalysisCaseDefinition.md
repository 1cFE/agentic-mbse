<div id="analysiscasedefinition" class="section">

<span id="metamodel-sysml-analysiscasedefinition"></span>

# AnalysisCaseDefinition[](#analysiscasedefinition "Link to this heading")

`AnalysisCaseDefinition` is defined in SysML specification on [page 405](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=405). Excerpt from the machine readable specification:
...
Attributes defined in [`AnalysisCaseDefinition`](#syside.AnalysisCaseDefinition "syside.AnalysisCaseDefinition"):
...
The following table lists Syside specific attributes available for class [`AnalysisCaseDefinition`](#syside.AnalysisCaseDefinition "syside.AnalysisCaseDefinition"):
...
| ------------------------------------------------------------------------------- |
| Python Attribute                                                                |
| [`STD`](#syside.AnalysisCaseDefinition.STD "syside.AnalysisCaseDefinition.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">AnalysisCaseDefinition</span></span>[](#syside.AnalysisCaseDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::AnalysisCaseDefinition'</span>*[](#syside.AnalysisCaseDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AnalysisCaseDefinition</span>](#syside.AnalysisCaseDefinition "syside.AnalysisCaseDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.AnalysisCaseDefinition.STD "Link to this definition")
