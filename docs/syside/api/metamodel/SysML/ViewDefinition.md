<div id="viewdefinition" class="section">

<span id="metamodel-sysml-viewdefinition"></span>

# ViewDefinition[](#viewdefinition "Link to this heading")

`ViewDefinition` is defined in SysML specification on [page 421](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=421). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `ViewDefinition` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: ViewDefinition digraph { ViewDefinition \[label="ViewDefinition (SysML)" shape=plaintext\] PartDefinition -\> ViewDefinition PartDefinition \[label="PartDefinition (SysML)" shape=plaintext\] ItemDefinition -\> PartDefinition ItemDefinition \[label="ItemDefinition (SysML)" shape=plaintext\] OccurrenceDefinition -\> ItemDefinition Structure -\> ItemDefinition OccurrenceDefinition \[label="OccurrenceDefinition (SysML)" shape=plaintext\] Definition -\> OccurrenceDefinition Class -\> OccurrenceDefinition Structure \[label="Structure (KerML)" shape=plaintext\] Class -\> Structure Definition \[label="Definition (SysML)" shape=plaintext\] Classifier -\> Definition Class \[label="Class (KerML)" shape=plaintext\] Classifier -\> Class Classifier \[label="Classifier (KerML)" shape=plaintext\] Type -\> Classifier Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-fe704144e74c4c464ebf5772e2cd3ac3001fa006.png)

</div>

</div>

The following table shows all attributes defined for `ViewDefinition` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`ViewDefinition`](#syside.ViewDefinition "syside.ViewDefinition"):

[`satisfied_viewpoints`](#syside.ViewDefinition.satisfied_viewpoints "syside.ViewDefinition.satisfied_viewpoints")
...
[`views`](#syside.ViewDefinition.views "syside.ViewDefinition.views")

The `usages` of this `ViewDefinition` that are `ViewUsages`.

[`view_conditions`](#syside.ViewDefinition.view_conditions "syside.ViewDefinition.view_conditions")
...
[`view_rendering`](#syside.ViewDefinition.view_rendering "syside.ViewDefinition.view_rendering")
...
The following table lists Syside specific attributes available for class [`ViewDefinition`](#syside.ViewDefinition "syside.ViewDefinition"):
...
| --------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                      |
| [`STD`](#syside.ViewDefinition.STD "syside.ViewDefinition.STD")                                                       |
| [`owned_view_conditions`](#syside.ViewDefinition.owned_view_conditions "syside.ViewDefinition.owned_view_conditions") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">ViewDefinition</span></span>[](#syside.ViewDefinition "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::ViewDefinition'</span>*[](#syside.ViewDefinition.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ViewDefinition</span>](#syside.ViewDefinition "syside.ViewDefinition")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.ViewDefinition.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">views</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ViewUsage</span>](/v0.8.1/api/metamodel/SysML/ViewUsage.md "syside.ViewUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewDefinition.views "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">satisfied\_viewpoints</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ViewpointUsage</span>](/v0.8.1/api/metamodel/SysML/ViewpointUsage.md "syside.ViewpointUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewDefinition.satisfied_viewpoints "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">view\_rendering</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RenderingUsage</span>](/v0.8.1/api/metamodel/SysML/RenderingUsage.md "syside.RenderingUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.ViewDefinition.view_rendering "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_view\_conditions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ElementFilterMembership</span>](/v0.8.1/api/metamodel/KerML/ElementFilterMembership.md "syside.ElementFilterMembership")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewDefinition.owned_view_conditions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">view\_conditions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ElementFilterMembership</span>](/v0.8.1/api/metamodel/KerML/ElementFilterMembership.md "syside.ElementFilterMembership")<span class="p"><span class="pre">\]</span></span>*[](#syside.ViewDefinition.view_conditions "Link to this definition")
