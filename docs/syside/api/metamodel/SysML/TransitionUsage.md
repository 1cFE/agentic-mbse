<div id="transitionusage" class="section">

<span id="metamodel-sysml-transitionusage"></span>

# TransitionUsage[](#transitionusage "Link to this heading")

`TransitionUsage` is defined in SysML specification on [page 375](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=375). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `TransitionUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: TransitionUsage digraph { TransitionUsage \[label="TransitionUsage (SysML)" shape=plaintext\] ActionUsage -\> TransitionUsage ActionUsage \[label="ActionUsage (SysML)" shape=plaintext\] OccurrenceUsage -\> ActionUsage Step -\> ActionUsage OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-01c16cd983fef965a9009f0c5e4a55354ae37ea6.png)

</div>

</div>

The following table shows all attributes defined for `TransitionUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`TransitionUsage`](#syside.TransitionUsage "syside.TransitionUsage"):

[`effect_action`](#syside.TransitionUsage.effect_action "syside.TransitionUsage.effect_action")
...
[`guard_expression`](#syside.TransitionUsage.guard_expression "syside.TransitionUsage.guard_expression")
...
[`source`](#syside.TransitionUsage.source "syside.TransitionUsage.source")

The source `ActionUsage` of this `TransitionUsage`, which becomes the `source` of the `succession` for the `TransitionUsage`.

[`succession`](#syside.TransitionUsage.succession "syside.TransitionUsage.succession")
...
[`target`](#syside.TransitionUsage.target "syside.TransitionUsage.target")

The target `ActionUsage` of this `TransitionUsage`, which is the `targetFeature` of the `succession` for the `TransitionUsage`.

[`trigger_action`](#syside.TransitionUsage.trigger_action "syside.TransitionUsage.trigger_action")
...
The following table lists Syside specific attributes available for class [`TransitionUsage`](#syside.TransitionUsage "syside.TransitionUsage"):
...
| ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                                                |
| [`STD`](#syside.TransitionUsage.STD "syside.TransitionUsage.STD")                                                                               |
| [`effect_action_member`](#syside.TransitionUsage.effect_action_member "syside.TransitionUsage.effect_action_member")                            |
| [`effect_actions`](#syside.TransitionUsage.effect_actions "syside.TransitionUsage.effect_actions")                                              |
| [`guard_expression_member`](#syside.TransitionUsage.guard_expression_member "syside.TransitionUsage.guard_expression_member")                   |
| [`guard_expressions`](#syside.TransitionUsage.guard_expressions "syside.TransitionUsage.guard_expressions")                                     |
| [`payload`](#syside.TransitionUsage.payload "syside.TransitionUsage.payload")                                                                   |
| [`payload_member`](#syside.TransitionUsage.payload_member "syside.TransitionUsage.payload_member")                                              |
| [`source_member`](#syside.TransitionUsage.source_member "syside.TransitionUsage.source_member")                                                 |
| [`succession_member`](#syside.TransitionUsage.succession_member "syside.TransitionUsage.succession_member")                                     |
| [`transition_link`](#syside.TransitionUsage.transition_link "syside.TransitionUsage.transition_link")                                           |
| [`transition_link_member`](#syside.TransitionUsage.transition_link_member "syside.TransitionUsage.transition_link_member")                      |
| [`transition_link_source`](#syside.TransitionUsage.transition_link_source "syside.TransitionUsage.transition_link_source")                      |
| [`transition_link_source_member`](#syside.TransitionUsage.transition_link_source_member "syside.TransitionUsage.transition_link_source_member") |
| [`trigger_action_member`](#syside.TransitionUsage.trigger_action_member "syside.TransitionUsage.trigger_action_member")                         |
| [`trigger_actions`](#syside.TransitionUsage.trigger_actions "syside.TransitionUsage.trigger_actions")                                           |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">TransitionUsage</span></span>[](#syside.TransitionUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::TransitionUsage'</span>*[](#syside.TransitionUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.TransitionUsage</span>](#syside.TransitionUsage "syside.TransitionUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.TransitionUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">source</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.source "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">source\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.TransitionSourceAccessor</span>](/v0.8.1/api/generated/syside.TransitionSourceAccessor.md "syside.TransitionSourceAccessor")*[](#syside.TransitionUsage.source_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.target "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">trigger\_action</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.AcceptActionUsage</span>](/v0.8.1/api/metamodel/SysML/AcceptActionUsage.md "syside.AcceptActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.trigger_action "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">trigger\_actions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">list</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.AcceptActionUsage</span>](/v0.8.1/api/metamodel/SysML/AcceptActionUsage.md "syside.AcceptActionUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.TransitionUsage.trigger_actions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">trigger\_action\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.TriggerAccessor</span>](/v0.8.1/api/generated/syside.TriggerAccessor.md "syside.TriggerAccessor")*[](#syside.TransitionUsage.trigger_action_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">guard\_expression</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Expression</span>](/v0.8.1/api/metamodel/KerML/Expression.md "syside.Expression")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.guard_expression "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">guard\_expressions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">list</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Expression</span>](/v0.8.1/api/metamodel/KerML/Expression.md "syside.Expression")<span class="p"><span class="pre">\]</span></span>*[](#syside.TransitionUsage.guard_expressions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">guard\_expression\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.GuardAccessor</span>](/v0.8.1/api/generated/syside.GuardAccessor.md "syside.GuardAccessor")*[](#syside.TransitionUsage.guard_expression_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">effect\_action</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.effect_action "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">effect\_actions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">list</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ActionUsage</span>](/v0.8.1/api/metamodel/SysML/ActionUsage.md "syside.ActionUsage")<span class="p"><span class="pre">\]</span></span>*[](#syside.TransitionUsage.effect_actions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">effect\_action\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.EffectAccessor</span>](/v0.8.1/api/generated/syside.EffectAccessor.md "syside.EffectAccessor")*[](#syside.TransitionUsage.effect_action_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">succession</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.SuccessionAsUsage</span>](/v0.8.1/api/metamodel/SysML/SuccessionAsUsage.md "syside.SuccessionAsUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.succession "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">succession\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.OwnedSuccessionAccessor</span>](/v0.8.1/api/generated/syside.OwnedSuccessionAccessor.md "syside.OwnedSuccessionAccessor")*[](#syside.TransitionUsage.succession_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">transition\_link\_source</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceUsage</span>](/v0.8.1/api/metamodel/SysML/ReferenceUsage.md "syside.ReferenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.transition_link_source "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">transition\_link\_source\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceParameterAccessor</span>](/v0.8.1/api/generated/syside.ReferenceParameterAccessor.md "syside.ReferenceParameterAccessor")*[](#syside.TransitionUsage.transition_link_source_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">transition\_link</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceUsage</span>](/v0.8.1/api/metamodel/SysML/ReferenceUsage.md "syside.ReferenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.transition_link "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">transition\_link\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceUsageAccessor</span>](/v0.8.1/api/generated/syside.ReferenceUsageAccessor.md "syside.ReferenceUsageAccessor")*[](#syside.TransitionUsage.transition_link_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">payload</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceUsage</span>](/v0.8.1/api/metamodel/SysML/ReferenceUsage.md "syside.ReferenceUsage")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.TransitionUsage.payload "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">payload\_member</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ReferenceParameterAccessor</span>](/v0.8.1/api/generated/syside.ReferenceParameterAccessor.md "syside.ReferenceParameterAccessor")*[](#syside.TransitionUsage.payload_member "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">behaviors</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Behavior</span>](/v0.8.1/api/metamodel/KerML/Behavior.md "syside.Behavior")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ActionDefinition</span>](/v0.8.1/api/metamodel/SysML/ActionDefinition.md "syside.ActionDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.TransitionUsage.behaviors "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owned\_parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.TransitionUsage.owned_parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">parameters</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="p"><span class="pre">\]</span></span>*[](#syside.TransitionUsage.parameters "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">action\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Behavior</span>](/v0.8.1/api/metamodel/KerML/Behavior.md "syside.Behavior")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span>[<span class="pre">syside.ActionDefinition</span>](/v0.8.1/api/metamodel/SysML/ActionDefinition.md "syside.ActionDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.TransitionUsage.action_definitions "Link to this definition")
