<div id="occurrenceusage" class="section">

<span id="metamodel-sysml-occurrenceusage"></span>

# OccurrenceUsage[](#occurrenceusage "Link to this heading")

`OccurrenceUsage` is defined in SysML specification on [page 318](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/2a-OMG_Systems_Modeling_Language.pdf#page=318). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `OccurrenceUsage` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: OccurrenceUsage digraph { OccurrenceUsage \[label="OccurrenceUsage (SysML)" shape=plaintext\] Usage -\> OccurrenceUsage Usage \[label="Usage (SysML)" shape=plaintext\] Feature -\> Usage Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-63c067f8778a0c9e2dce4669b878f3eaf5141bb3.png)

</div>

</div>

The following table shows all attributes defined for `OccurrenceUsage` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`OccurrenceUsage`](#syside.OccurrenceUsage "syside.OccurrenceUsage"):

[`individual_definition`](#syside.OccurrenceUsage.individual_definition "syside.OccurrenceUsage.individual_definition")

The at most one `occurrenceDefinition` that has `isIndividual = true`.

[`is_individual`](#syside.OccurrenceUsage.is_individual "syside.OccurrenceUsage.is_individual")

Whether this `OccurrenceUsage` represents the usage of the specific individual represented by its `individualDefinition`.

[`occurrence_definitions`](#syside.OccurrenceUsage.occurrence_definitions "syside.OccurrenceUsage.occurrence_definitions")
...
[`portion_kind`](#syside.OccurrenceUsage.portion_kind "syside.OccurrenceUsage.portion_kind")
...
The following table lists Syside specific attributes available for class [`OccurrenceUsage`](#syside.OccurrenceUsage "syside.OccurrenceUsage"):
...
| ----------------------------------------------------------------- |
| Python Attribute                                                  |
| [`STD`](#syside.OccurrenceUsage.STD "syside.OccurrenceUsage.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">OccurrenceUsage</span></span>[](#syside.OccurrenceUsage "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::OccurrenceUsage'</span>*[](#syside.OccurrenceUsage.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">Union</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.OccurrenceUsage</span>](#syside.OccurrenceUsage "syside.OccurrenceUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.ConnectionUsage</span>](/v0.8.1/api/metamodel/SysML/ConnectionUsage.md "syside.ConnectionUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.FlowUsage</span>](/v0.8.1/api/metamodel/SysML/FlowUsage.md "syside.FlowUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.OccurrenceUsage.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">is\_individual</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span>*[](#syside.OccurrenceUsage.is_individual "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">portion\_kind</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.PortionKind</span>](/v0.8.1/api/metamodel/SysML/PortionKind.md "syside.PortionKind")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.OccurrenceUsage.portion_kind "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">occurrence\_definitions</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.LazyIterator</span>](/v0.8.1/api/generated/syside.LazyIterator.md "syside.LazyIterator")<span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.OccurrenceDefinition</span>](/v0.8.1/api/metamodel/SysML/OccurrenceDefinition.md "syside.OccurrenceDefinition")<span class="p"><span class="pre">\]</span></span>*[](#syside.OccurrenceUsage.occurrence_definitions "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">individual\_definition</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.OccurrenceDefinition</span>](/v0.8.1/api/metamodel/SysML/OccurrenceDefinition.md "syside.OccurrenceDefinition")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.OccurrenceUsage.individual_definition "Link to this definition")
