<div id="indexexpression" class="section">

<span id="metamodel-kerml-indexexpression"></span>

# IndexExpression[](#indexexpression "Link to this heading")

`IndexExpression` is defined in KerML specification on [page 237](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=237). Excerpt from the machine readable specification:
...
Attributes defined in [`IndexExpression`](#syside.IndexExpression "syside.IndexExpression"):
...
The following table lists Syside specific attributes available for class [`IndexExpression`](#syside.IndexExpression "syside.IndexExpression"):
...
| ----------------------------------------------------------------- |
| Python Attribute                                                  |
| [`STD`](#syside.IndexExpression.STD "syside.IndexExpression.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">IndexExpression</span></span>[](#syside.IndexExpression "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::IndexExpression'</span>*[](#syside.IndexExpression.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.IndexExpression</span>](#syside.IndexExpression "syside.IndexExpression")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.IndexExpression.STD "Link to this definition")
