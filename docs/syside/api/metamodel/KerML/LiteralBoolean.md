<div id="literalboolean" class="section">

<span id="metamodel-kerml-literalboolean"></span>

# LiteralBoolean[](#literalboolean "Link to this heading")

`LiteralBoolean` is defined in KerML specification on [page 241](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=241). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `LiteralBoolean` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: LiteralBoolean digraph { LiteralBoolean \[label="LiteralBoolean (KerML)" shape=plaintext\] LiteralExpression -\> LiteralBoolean LiteralExpression \[label="LiteralExpression (KerML)" shape=plaintext\] Expression -\> LiteralExpression Expression \[label="Expression (KerML)" shape=plaintext\] Step -\> Expression Step \[label="Step (KerML)" shape=plaintext\] Feature -\> Step Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-13ca79d0000ace9d2f34c6d39ba92fcd2494b3c4.png)

</div>

</div>

The following table shows all attributes defined for `LiteralBoolean` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`LiteralBoolean`](#syside.LiteralBoolean "syside.LiteralBoolean"):

[`value`](#syside.LiteralBoolean.value "syside.LiteralBoolean.value")
...
The following table lists Syside specific attributes available for class [`LiteralBoolean`](#syside.LiteralBoolean "syside.LiteralBoolean"):
...
| --------------------------------------------------------------- |
| Python Attribute                                                |
| [`STD`](#syside.LiteralBoolean.STD "syside.LiteralBoolean.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">LiteralBoolean</span></span>[](#syside.LiteralBoolean "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::LiteralBoolean'</span>*[](#syside.LiteralBoolean.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.LiteralBoolean</span>](#syside.LiteralBoolean "syside.LiteralBoolean")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.LiteralBoolean.STD "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">value</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span>*[](#syside.LiteralBoolean.value "Link to this definition")
