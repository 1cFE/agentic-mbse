<div id="endfeaturemembership" class="section">

<span id="metamodel-kerml-endfeaturemembership"></span>

# EndFeatureMembership[](#endfeaturemembership "Link to this heading")

`EndFeatureMembership` is defined in KerML specification on [page 187](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=187). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `EndFeatureMembership` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: EndFeatureMembership digraph { EndFeatureMembership \[label="EndFeatureMembership (KerML)" shape=plaintext\] FeatureMembership -\> EndFeatureMembership FeatureMembership \[label="FeatureMembership (KerML)" shape=plaintext\] OwningMembership -\> FeatureMembership OwningMembership \[label="OwningMembership (KerML)" shape=plaintext\] Membership -\> OwningMembership Membership \[label="Membership (KerML)" shape=plaintext\] Relationship -\> Membership Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-9d25fda025d1e78313707653ef589d8747f61b34.png)

</div>

</div>

The following table shows all attributes defined for `EndFeatureMembership` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`EndFeatureMembership`](#syside.EndFeatureMembership "syside.EndFeatureMembership"):
...
The following table lists Syside specific attributes available for class [`EndFeatureMembership`](#syside.EndFeatureMembership "syside.EndFeatureMembership"):
...
| --------------------------------------------------------------------------- |
| Python Attribute                                                            |
| [`STD`](#syside.EndFeatureMembership.STD "syside.EndFeatureMembership.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">EndFeatureMembership</span></span>[](#syside.EndFeatureMembership "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::EndFeatureMembership'</span>*[](#syside.EndFeatureMembership.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.EndFeatureMembership</span>](#syside.EndFeatureMembership "syside.EndFeatureMembership")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.EndFeatureMembership.STD "Link to this definition")
