<div id="crosssubsetting" class="section">

<span id="metamodel-kerml-crosssubsetting"></span>

# CrossSubsetting[](#crosssubsetting "Link to this heading")

`CrossSubsetting` is defined in KerML specification on [page 186](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=186). Excerpt from the machine readable specification:
...
![// Class: CrossSubsetting digraph { CrossSubsetting \[label="CrossSubsetting (KerML)" shape=plaintext\] Subsetting -\> CrossSubsetting Subsetting \[label="Subsetting (KerML)" shape=plaintext\] Specialization -\> Subsetting Specialization \[label="Specialization (KerML)" shape=plaintext\] Relationship -\> Specialization Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-28f63db4dadaa99a5e5a67bc10cbe3d11e6eec0e.png)
...
Attributes defined in [`CrossSubsetting`](#syside.CrossSubsetting "syside.CrossSubsetting"):

[`crossed_feature`](#syside.CrossSubsetting.crossed_feature "syside.CrossSubsetting.crossed_feature")

The chained `Feature` that is cross subset by the `crossingFeature` of this `CrossSubsetting`.

[`crossing_feature`](#syside.CrossSubsetting.crossing_feature "syside.CrossSubsetting.crossing_feature")

The end `Feature` that owns this `CrossSubsetting` relationship and is also its subsettingFeature.

Attributes defined in [`Subsetting`](/v0.8.1/api/metamodel/KerML/Subsetting.md "syside.Subsetting"):

[`owning_feature`](/v0.8.1/api/metamodel/KerML/Subsetting.md "syside.Subsetting.owning_feature")

A `subsettingFeature` that is also the `owningRelatedElement` of this `Subsetting`.

[`subsetted_feature`](/v0.8.1/api/metamodel/KerML/Subsetting.md "syside.Subsetting.subsetted_feature")

The `Feature` that is subsetted by the `subsettingFeature` of this `Subsetting`.

[`subsetting_feature`](/v0.8.1/api/metamodel/KerML/Subsetting.md "syside.Subsetting.subsetting_feature")
...
The following table lists Syside specific attributes available for class [`CrossSubsetting`](#syside.CrossSubsetting "syside.CrossSubsetting"):
...
| ----------------------------------------------------------------------------------------------------------------------------- |
| Python Attribute                                                                                                              |
| [`CHAINABLE`](#syside.CrossSubsetting.CHAINABLE "syside.CrossSubsetting.CHAINABLE")                                           |
| [`STD`](#syside.CrossSubsetting.STD "syside.CrossSubsetting.STD")                                                             |
| [`crossed_feature_target`](#syside.CrossSubsetting.crossed_feature_target "syside.CrossSubsetting.crossed_feature_target")    |
| [`crossing_feature_target`](#syside.CrossSubsetting.crossing_feature_target "syside.CrossSubsetting.crossing_feature_target") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">CrossSubsetting</span></span>[](#syside.CrossSubsetting "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::CrossSubsetting'</span>*[](#syside.CrossSubsetting.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.CrossSubsetting</span>](#syside.CrossSubsetting "syside.CrossSubsetting")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.CrossSubsetting.STD "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">CHAINABLE</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">True</span>*[](#syside.CrossSubsetting.CHAINABLE "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">crossed\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.CrossSubsetting.crossed_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">crossing\_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Feature</span>](/v0.8.1/api/metamodel/KerML/Feature.md "syside.Feature")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.CrossSubsetting.crossing_feature "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">crossed\_feature\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedFeatureReference</span>](/v0.8.1/api/generated/syside.ChainedFeatureReference.md "syside.ChainedFeatureReference")*[](#syside.CrossSubsetting.crossed_feature_target "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">crossing\_feature\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedFeatureReference</span>](/v0.8.1/api/generated/syside.ChainedFeatureReference.md "syside.ChainedFeatureReference")*[](#syside.CrossSubsetting.crossing_feature_target "Link to this definition")
