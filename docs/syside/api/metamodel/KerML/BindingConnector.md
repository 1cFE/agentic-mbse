<div id="bindingconnector" class="section">

<span id="metamodel-kerml-bindingconnector"></span>

# BindingConnector[](#bindingconnector "Link to this heading")

`BindingConnector` is defined in KerML specification on [page 77](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=77). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `BindingConnector` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: BindingConnector digraph { BindingConnector \[label="BindingConnector (KerML)" shape=plaintext\] Connector -\> BindingConnector Connector \[label="Connector (KerML)" shape=plaintext\] Feature -\> Connector Relationship -\> Connector Feature \[label="Feature (KerML)" shape=plaintext\] Type -\> Feature Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Type \[label="Type (KerML)" shape=plaintext\] Namespace -\> Type Element \[label="Element (KerML)" shape=plaintext\] Namespace \[label="Namespace (KerML)" shape=plaintext\] Element -\> Namespace }](_images/graphviz-a62841135aec01b323325383f3600c93a9335fea.png)

</div>

</div>

The following table shows all attributes defined for `BindingConnector` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`BindingConnector`](#syside.BindingConnector "syside.BindingConnector"):
...
The following table lists Syside specific attributes available for class [`BindingConnector`](#syside.BindingConnector "syside.BindingConnector"):
...
| ------------------------------------------------------------------- |
| Python Attribute                                                    |
| [`STD`](#syside.BindingConnector.STD "syside.BindingConnector.STD") |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">BindingConnector</span></span>[](#syside.BindingConnector "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::BindingConnector'</span>*[](#syside.BindingConnector.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">Union</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.BindingConnector</span>](#syside.BindingConnector "syside.BindingConnector")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">BindingConnectorAsUsage</span>](/v0.8.1/api/metamodel/SysML/BindingConnectorAsUsage.md "syside.BindingConnectorAsUsage")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.BindingConnector.STD "Link to this definition")
