...
<span id="metamodel-kerml-conjugation"></span>

# Conjugation[](#conjugation "Link to this heading")

`Conjugation` is defined in KerML specification on [page 54](https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=54). Excerpt from the machine readable specification:
...
The following diagram shows the inheritance hierarchy of `Conjugation` according to the specification:

<div class="align-center" data-align="center">

<div class="graphviz">

![// Class: Conjugation digraph { Conjugation \[label="Conjugation (KerML)" shape=plaintext\] Relationship -\> Conjugation Relationship \[label="Relationship (KerML)" shape=plaintext\] Element -\> Relationship Element \[label="Element (KerML)" shape=plaintext\] }](_images/graphviz-90a63be9de1aef189006f36d705c471380c822d9.png)

</div>

</div>

The following table shows all attributes defined for `Conjugation` according to the specification together with the documentation from the machine readable specification. Note that in Syside API, we use snake case for attribute names instead of Pascal case used in the specification.
...
Attributes defined in [`Conjugation`](#syside.Conjugation "syside.Conjugation"):

[`conjugated_type`](#syside.Conjugation.conjugated_type "syside.Conjugation.conjugated_type")

The `Type` that is the result of applying `Conjugation` to the `originalType`.

[`original_type`](#syside.Conjugation.original_type "syside.Conjugation.original_type")

The `Type` to be conjugated.

[`owning_type`](#syside.Conjugation.owning_type "syside.Conjugation.owning_type")
...
The following table lists Syside specific attributes available for class [`Conjugation`](#syside.Conjugation "syside.Conjugation"):
...
| ------------------------------------------------------------------------------------------------------------------ |
| Python Attribute                                                                                                   |
| [`CHAINABLE`](#syside.Conjugation.CHAINABLE "syside.Conjugation.CHAINABLE")                                        |
| [`STD`](#syside.Conjugation.STD "syside.Conjugation.STD")                                                          |
| [`children`](#syside.Conjugation.children "syside.Conjugation.children")                                           |
| [`conjugated_type_target`](#syside.Conjugation.conjugated_type_target "syside.Conjugation.conjugated_type_target") |
| [`original_type_target`](#syside.Conjugation.original_type_target "syside.Conjugation.original_type_target")       |

</div>

  - *<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">Conjugation</span></span>[](#syside.Conjugation "Link to this definition")
    
      - <span class="sig-name descname"><span class="pre">\_\_cpp\_name\_\_</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">str</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">'syside::sysml::Conjugation'</span>*[](#syside.Conjugation.__cpp_name__ "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span>[<span class="pre">syside.Conjugation</span>](#syside.Conjugation "syside.Conjugation")<span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*[](#syside.Conjugation.STD "Link to this definition")
    
    <!-- end list -->
    
      - <span class="sig-name descname"><span class="pre">CHAINABLE</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">bool</span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">True</span>*[](#syside.Conjugation.CHAINABLE "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">original\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.Conjugation.original_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">conjugated\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.Conjugation.conjugated_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning\_type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.Type</span>](/v0.8.1/api/metamodel/KerML/Type.md "syside.Type")<span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">None</span>*[](#syside.Conjugation.owning_type "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">children</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.RelationshipBody</span>](/v0.8.1/api/generated/syside.RelationshipBody.md "syside.RelationshipBody")*[](#syside.Conjugation.children "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">original\_type\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedTypeReference</span>](/v0.8.1/api/generated/syside.ChainedTypeReference.md "syside.ChainedTypeReference")*[](#syside.Conjugation.original_type_target "Link to this definition")
    
    <!-- end list -->
    
      - *<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">conjugated\_type\_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span>[<span class="pre">syside.ChainedTypeReference</span>](/v0.8.1/api/generated/syside.ChainedTypeReference.md "syside.ChainedTypeReference")*[](#syside.Conjugation.conjugated_type_target "Link to this definition")
