<div id="featuretyping-sysml" class="section">

# FeatureTyping <span class="sd-sphinx-override sd-badge sd-outline-primary sd-text-primary">SysML</span><a href="#featuretyping-sysml" class="headerlink" title="Link to this heading"><span class="nerd-font"></span></a>

*<span class="pre">class</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">FeatureTyping</span></span><a href="#syside.FeatureTyping" class="headerlink" title="Link to this definition"><span class="nerd-font"></span></a>  
Implementation of <span class="pre">`FeatureTyping`</span> defined in the KerML specification.

**Specification**:

> <div>
>
> <span class="pre">`FeatureTyping`</span> is <span class="pre">`Specialization`</span> in which the <span class="pre">`specific`</span> <span class="pre">`Type`</span> is a <span class="pre">`Feature`</span>. This means the set of instances of the (specific) <span class="pre">`typed_feature`</span> is a subset of the set of instances of the (general) <span class="pre">`type`</span>. In the simplest case, the <span class="pre">`type`</span> is a <span class="pre">`Classifier`</span>, whereupon the <span class="pre">`typed_feature`</span> has values that are instances of the <span class="pre">`Classifier`</span>.
>
> </div>

For language description, see section <a href="https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=61" class="reference external" target="_blank">7.3.4.3</a> of the KerML specification. For more details on the model, see section <a href="https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=203" class="reference external" target="_blank">8.3.3.3.7</a> of the KerML specification.

<div class="align-center" align="center">

<img src="data:image/svg+xml;base64," class="graphviz" />
...
<span class="sd-summary-text">Members defined in <a href="#syside.FeatureTyping" class="reference internal" title="syside.FeatureTyping"><span class="pre"><code class="sourceCode python">FeatureTyping</code></span></a> (6 members)</span><span class="sd-summary-state-marker sd-summary-chevron-right"><img src="data:image/svg+xml;base64," class="sd-octicon sd-octicon-chevron-right" /></span>
...
|  |  |  |  |
|----|----|----|----|
| <span class="nerd-font"></span> | <a href="#syside.FeatureTyping.STD" class="reference internal" title="syside.FeatureTyping.STD"><span class="pre"><code class="sourceCode python">STD</code></span></a> | <span class="pre">`R`</span> |  |
| <span class="nerd-font"></span> | <a href="#syside.FeatureTyping.owning_feature" class="reference internal" title="syside.FeatureTyping.owning_feature"><span class="pre"><code class="sourceCode python">owning_feature</code></span></a> | <span class="pre">`R`</span> <span class="sd-sphinx-override sd-badge sd-outline-primary sd-text-primary">SysML</span> | Implementation of <span class="pre">`owning_feature`</span> defined in the KerML specification. |
| <span class="nerd-font"></span> | <a href="#syside.FeatureTyping.type" class="reference internal" title="syside.FeatureTyping.type"><span class="pre"><code class="sourceCode python"><span class="bu">type</span></code></span></a> | <span class="pre">`R`</span> <span class="sd-sphinx-override sd-badge sd-outline-primary sd-text-primary">SysML</span> | Implementation of <span class="pre">`type`</span> defined in the KerML specification. |
| <span class="nerd-font"></span> | <a href="#syside.FeatureTyping.type_target" class="reference internal" title="syside.FeatureTyping.type_target"><span class="pre"><code class="sourceCode python">type_target</code></span></a> | <span class="pre">`R`</span> | Syside specific accessor for manipulating the target of <span class="pre">`type`</span>. |
| <span class="nerd-font"></span> | <a href="#syside.FeatureTyping.typed_feature" class="reference internal" title="syside.FeatureTyping.typed_feature"><span class="pre"><code class="sourceCode python">typed_feature</code></span></a> | <span class="pre">`R`</span> <span class="sd-sphinx-override sd-badge sd-outline-primary sd-text-primary">SysML</span> | Implementation of <span class="pre">`typed_feature`</span> defined in the KerML specification. |
| <span class="nerd-font"></span> | <a href="#syside.FeatureTyping.typed_feature_target" class="reference internal" title="syside.FeatureTyping.typed_feature_target"><span class="pre"><code class="sourceCode python">typed_feature_target</code></span></a> | <span class="pre">`R`</span> | Syside specific accessor for manipulating the target of <span class="pre">`typed_feature`</span>. |
...
<span class="sig-name descname"><span class="pre">STD</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">tuple</span><span class="p"><span class="pre">\[</span></span><span class="pre">type</span><span class="p"><span class="pre">\[</span></span><a href="#syside.FeatureTyping" class="reference internal" title="syside.FeatureTyping"><span class="pre">syside.FeatureTyping</span></a><span class="p"><span class="pre">\]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">\]</span></span><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">()</span>*<a href="#syside.FeatureTyping.STD" class="headerlink" title="Link to this definition"><span class="nerd-font"></span></a>  

*<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">owning_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><a href="/python/v0.8.4/syside/Feature.md" class="reference internal" title="syside.Feature"><span class="pre">syside.Feature</span></a><span class="w"> </span><span class="p"><span class="pre">\|</span></span><span class="w"> </span><span class="pre">None</span>*<a href="#syside.FeatureTyping.owning_feature" class="headerlink" title="Link to this definition"><span class="nerd-font"></span></a>  
Implementation of <span class="pre">`owning_feature`</span> defined in the KerML specification.

**Specification**:

> <div>
>
> A <span class="pre">`typed_feature`</span> that is also the <span class="pre">`owning_related_element`</span> of this <span class="pre">`FeatureTyping`</span>.
>
> </div>

See section <a href="https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=203" class="reference external" target="_blank">8.3.3.3.7</a> of the KerML specification for more details.

*<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">type</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><a href="/python/v0.8.4/syside/Type.md" class="reference internal" title="syside.Type"><span class="pre">syside.Type</span></a><span class="w"> </span><span class="p"><span class="pre">\|</span></span><span class="w"> </span><span class="pre">None</span>*<a href="#syside.FeatureTyping.type" class="headerlink" title="Link to this definition"><span class="nerd-font"></span></a>  
...
> <div>
>
> The <span class="pre">`Type`</span> that is being applied by this <span class="pre">`FeatureTyping`</span>.
>
> </div>

See section <a href="https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=203" class="reference external" target="_blank">8.3.3.3.7</a> of the KerML specification for more details.

*<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">type_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><a href="/python/v0.8.4/syside/ChainedTypeReference.md" class="reference internal" title="syside.ChainedTypeReference"><span class="pre">syside.ChainedTypeReference</span></a>*<a href="#syside.FeatureTyping.type_target" class="headerlink" title="Link to this definition"><span class="nerd-font"></span></a>  
Syside specific accessor for manipulating the target of <span class="pre">`type`</span>.

*<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">typed_feature</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><a href="/python/v0.8.4/syside/Feature.md" class="reference internal" title="syside.Feature"><span class="pre">syside.Feature</span></a><span class="w"> </span><span class="p"><span class="pre">\|</span></span><span class="w"> </span><span class="pre">None</span>*<a href="#syside.FeatureTyping.typed_feature" class="headerlink" title="Link to this definition"><span class="nerd-font"></span></a>  
Implementation of <span class="pre">`typed_feature`</span> defined in the KerML specification.

**Specification**:

> <div>
>
> The <span class="pre">`Feature`</span> that has a <span class="pre">`type`</span> determined by this <span class="pre">`FeatureTyping`</span>.
>
> </div>

See section <a href="https://raw.githubusercontent.com/Systems-Modeling/SysML-v2-Release/refs/tags/2025-07/doc/1-Kernel_Modeling_Language.pdf#page=203" class="reference external" target="_blank">8.3.3.3.7</a> of the KerML specification for more details.

*<span class="pre">property</span><span class="w"> </span>*<span class="sig-name descname"><span class="pre">typed_feature_target</span></span>*<span class="p"><span class="pre">:</span></span><span class="w"> </span><a href="/python/v0.8.4/syside/ChainedFeatureReference.md" class="reference internal" title="syside.ChainedFeatureReference"><span class="pre">syside.ChainedFeatureReference</span></a>*<a href="#syside.FeatureTyping.typed_feature_target" class="headerlink" title="Link to this definition"><span class="nerd-font"></span></a>  
Syside specific accessor for manipulating the target of <span class="pre">`typed_feature`</span>.
...
- <a href="/python/v0.8.4/syside/Feature.md" class="reference internal" title="syside.Feature"><span class="pre"><code class="sourceCode python">syside.Feature</code></span></a>
  ...
  - <a href="/python/v0.8.4/syside/Feature.md" class="reference internal" title="syside.Feature.owned_typings"><span class="pre"><code class="sourceCode python">owned_typings</code></span></a>

- <a href="#syside.FeatureTyping" class="reference internal" title="syside.FeatureTyping"><span class="pre"><code class="sourceCode python">syside.FeatureTyping</code></span></a>

  - <a href="#syside.FeatureTyping.STD" class="reference internal" title="syside.FeatureTyping.STD"><span class="pre"><code class="sourceCode python">STD</code></span></a>
